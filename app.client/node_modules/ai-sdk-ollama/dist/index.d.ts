...
import { RerankingModelV4, RerankingModelV4CallOptions, JSONSchema7, ProviderV4, LanguageModelV4, EmbeddingModelV4, ImageModelV4, ImageModelV4CallOptions, SharedV4Warning, ImageModelV4Usage, ImageModelV4ProviderMetadata } from '@ai-sdk/provider';
import { Ollama, ChatRequest, Options as Options$1, EmbedRequest, Config } from 'ollama';
import { z } from 'zod';
import * as _ai_sdk_provider_utils from '@ai-sdk/provider-utils';
import { FetchFunction } from '@ai-sdk/provider-utils';
import * as ai from 'ai';
import { generateText as generateText$1, streamText as streamText$1 } from 'ai';
export { Agent, AgentCallParameters, AgentStreamParameters, AsyncIterableStream, ChunkDetector, GenerateTextOnFinishCallback, GenerateTextOnStepFinishCallback, LanguageModelMiddleware, ToolLoopAgent, ToolLoopAgentSettings, defaultSettingsMiddleware, extractReasoningMiddleware, hasToolCall, parsePartialJson, simulateReadableStream, simulateStreamingMiddleware, smoothStream, stepCountIs, wrapLanguageModel } from 'ai';
 ...
 * ```
 */
declare class OllamaRerankingModel implements RerankingModelV4 {
    ...
    get provider(): string;
    doRerank({ documents, headers, query, topN, abortSignal, providerOptions, }: RerankingModelV4CallOptions): Promise<Awaited<ReturnType<RerankingModelV4['doRerank']>>>;
}
 ...
 * ```
 */
declare class OllamaEmbeddingRerankingModel implements RerankingModelV4 {
    readonly specificationVersion: "v4";
    readonly modelId: string;
    private readonly config;
    private readonly settings;
...
declare function webSearch(options?: WebSearchToolOptions): ({
    title?: string;
    providerOptions?: _ai_sdk_provider_utils.ProviderOptions;
    metadata?: _ai_sdk_provider.JSONObject;
    inputSchema: ai.FlexibleSchema<{
        query: string;
        maxResults?: number | undefined;
    }>;
    contextSchema?: ai.FlexibleSchema<_ai_sdk_provider_utils.Context> | undefined;
    needsApproval?: boolean | _ai_sdk_provider_utils.ToolNeedsApprovalFunction<{
        query: string;
        maxResults?: number | undefined;
    }, NoInfer<_ai_sdk_provider_utils.Context>> | undefined;
    onInputStart?: ((options: ai.ToolExecutionOptions<NoInfer<_ai_sdk_provider_utils.Context>>) => void | PromiseLike<void>) | undefined;
    onInputDelta?: ((options: {
        inputTextDelta: string;
    } & ai.ToolExecutionOptions<NoInfer<_ai_sdk_provider_utils.Context>>) => void | PromiseLike<void>) | undefined;
    ...
    toModelOutput?: ((options: {
        ...
        output: NoInfer<WebSearchOutput>;
    }) => _ai_sdk_provider_utils.ToolResultOutput | PromiseLike<_ai_sdk_provider_utils.ToolResultOutput>) | undefined;
} & {
    outputSchema?: ai.FlexibleSchema<WebSearchOutput> | undefined;
    execute: ai.ToolExecuteFunction<{
        query: string;
        maxResults?: number | undefined;
    }, WebSearchOutput, NoInfer<_ai_sdk_provider_utils.Context>>;
} & {
    description?: string | ((options: {
        context: NoInfer<_ai_sdk_provider_utils.Context>;
        experimental_sandbox?: ai.Experimental_SandboxSession;
    }) => string) | undefined;
    strict?: boolean;
    inputExamples?: {
        input: NoInfer<{
 ...
 * ```
 */
declare function webFetch(options?: WebFetchToolOptions): ({
    title?: string;
    providerOptions?: _ai_sdk_provider_utils.ProviderOptions;
    metadata?: _ai_sdk_provider.JSONObject;
    inputSchema: ai.FlexibleSchema<{
    ...
    outputSchema?: ai.FlexibleSchema<WebFetchOutput> | undefined;
    execute: ai.ToolExecuteFunction<{
        url: string;
    }, WebFetchOutput, NoInfer<_ai_sdk_provider_utils.Context>>;
} & {
    description?: string | ((options: {
        context: NoInfer<_ai_sdk_provider_utils.Context>;
        experimental_sandbox?: ai.Experimental_SandboxSession;
...
interface OllamaProvider extends ProviderV4 {
    /**
 ...
 */
declare class OllamaImageModel implements ImageModelV4 {
    private readonly config;
    readonly specificationVersion: "v4";
    ...
    doGenerate(options: ImageModelV4CallOptions): Promise<{
        images: Array<string>;
