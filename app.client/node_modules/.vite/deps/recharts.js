...
import { i as combineReducers } from "./redux-Cmom5h6r.js";
import { t as Provider_default } from "./react-redux-C8LV_2aK.js";
import { t as invariant } from "./tiny-invariant-BLxz885y.js";
import { C as createSlice, H as createSelector, K as castDraft, b as createListenerMiddleware, d as configureStore, f as createAction, q as current } from "./redux-toolkit.modern-CPvK5cBg.js";
import { t as require_with_selector } from "./with-selector-CxtsUGpw.js";
...
var Surface = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	var { children, width, height, viewBox, className, style, title, desc } = props, others = _objectWithoutProperties$34(props, _excluded$34);
	var svgView = viewBox || {
		width,
		height,
		x: 0,
	...
	return /* @__PURE__ */ import_react.createElement("svg", _extends$47({}, filterProps(others, true, "svg"), {
...
var _excluded$33 = ["children", "className"];
...
var Layer = /* @__PURE__ */ import_react.forwardRef((props, ref) => {
	var { children, className } = props, others = _objectWithoutProperties$33(props, _excluded$33);
	var layerClass = clsx("recharts-layer", className);
	return /* @__PURE__ */ import_react.createElement("g", _extends$46({ className: layerClass }, filterProps(others, true), { ref }), children);
});
//#endregion
...
var Symbols = (_ref) => {
	...
	var props = _objectSpread$59(_objectSpread$59({}, _objectWithoutProperties$32(_ref, _excluded$32)), {}, {
		type,
		size,
		sizeType
	});
	...
	*/
	...
	if (cx === +cx && cy === +cy && size === +size) return /* @__PURE__ */ import_react.createElement("path", _extends$45({}, filteredProps, {
...
var DefaultLegendContent = class extends import_react.PureComponent {
	...
	*/
	renderIcon(data, iconType) {
		...
		if (/* @__PURE__ */ import_react.isValidElement(data.legendIcon)) {
			var iconProps = _objectSpread$58({}, data);
	...
	*/
	renderItems() {
		...
		return (itemSorter ? (0, import_sortBy.default)(payload, itemSorter) : payload).map((entry, i) => {
			...
			return /* @__PURE__ */ import_react.createElement("li", _extends$44({
				className,
				style: itemStyle,
...
_defineProperty$62(DefaultLegendContent, "displayName", "Legend");
_defineProperty$62(DefaultLegendContent, "defaultProps", {
	align: "center",
	iconSize: 14,
	inactiveColor: "#ccc",
	itemSorter: "value",
...
var inRangeOfSector = (_ref5, viewBox) => {
	...
	if (inRange) return _objectSpread$57(_objectSpread$57({}, viewBox), {}, {
		radius,
...
var appendOffsetOfLegend = (offset, legendSettings, legendSize) => {
	if (legendSettings && legendSize) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$56(_objectSpread$56({}, offset), {}, { [align]: offset[align] + (boxWidth || 0) });
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$56(_objectSpread$56({}, offset), {}, { [verticalAlign]: offset[verticalAlign] + (boxHeight || 0) });
	}
	return offset;
};
...
var getStackedData = (data, dataKeys, offsetType) => {
	...
	return stack_default().keys(dataKeys).value((d, key) => +getValueByDataKey(d, key, 0)).order(none_default).offset(offsetAccessor)(data);
};
/**
...
function getTooltipEntry(_ref4) {
	...
	return _objectSpread$56(_objectSpread$56({}, tooltipEntrySettings), {}, {
		dataKey,
		payload,
		value,
		name
...
var getActiveCoordinate = (layout, tooltipTicks, activeIndex, rangeObj) => {
	...
	if (entry) {
		...
		if (layout === "centric") {
			...
			return _objectSpread$56(_objectSpread$56(_objectSpread$56({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, _radius, _angle)), {}, {
				angle: _angle,
				radius: _radius
			});
		}
		...
		var { angle } = rangeObj;
		return _objectSpread$56(_objectSpread$56(_objectSpread$56({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, radius, angle)), {}, {
			angle,
			radius
		});
	}
...
var selectChartOffset = createSelector([
	selectChartWidth,
	selectChartHeight,
	selectMargin,
	selectBrushHeight,
	...
	var offsetH = yAxes.reduce((result, entry) => {
		...
		if (!entry.mirror && !entry.hide) {
			var width = typeof entry.width === "number" ? entry.width : 60;
			return _objectSpread$55(_objectSpread$55({}, result), {}, { [orientation]: result[orientation] + width });
		}
		return result;
	}, {
		left: margin.left || 0,
	...
	var offset = _objectSpread$55(_objectSpread$55({}, xAxes.reduce((result, entry) => {
		var { orientation } = entry;
		if (!entry.mirror && !entry.hide) return _objectSpread$55(_objectSpread$55({}, result), {}, { [orientation]: (0, import_get.default)(result, "".concat(orientation)) + entry.height });
		return result;
	}, {
		top: margin.top || 0,
	...
	return _objectSpread$55(_objectSpread$55({ brushBottom }, offset), {}, {
...
var _excluded$31 = ["contextPayload"];
...
function LegendContent(props) {
	var { contextPayload } = props, otherProps = _objectWithoutProperties$31(props, _excluded$31);
...
_defineProperty$58(Legend, "displayName", "Legend");
_defineProperty$58(Legend, "defaultProps", {
	align: "center",
	iconSize: 14,
	layout: "horizontal",
...
var DefaultTooltipContent = (props) => {
	...
	var renderContent = () => {
		if (payload && payload.length) {
			...
			var items = (itemSorter ? (0, import_sortBy.default)(payload, itemSorter) : payload).map((entry, i) => {
				if (entry.type === "none") return null;
...
var TooltipBoundingBox = class extends import_react.PureComponent {
	constructor() {
		...
		_defineProperty$56(this, "handleKeyDown", (event) => {
			if (event.key === "Escape") {
	...
	render() {
		...
		var outerStyle = _objectSpread$52(_objectSpread$52({}, hasPortalFromProps ? {} : _objectSpread$52(_objectSpread$52({ transition: isAnimationActive && active ? "transform ".concat(animationDuration, "ms ").concat(animationEasing) : void 0 }, cssProperties), {}, {
			pointerEvents: "none",
...
var Global = { isSsr: parseIsSsrByDefault() };
//#endregion
...
var Curve = (props) => {
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$41({}, filterProps(props, false), adaptEventHandlers(props), {
...
var Cross = (_ref) => {
	var { x = 0, y = 0, top = 0, left = 0, width = 0, height = 0, className } = _ref, rest = _objectWithoutProperties$30(_ref, _excluded$30);
	...
	return /* @__PURE__ */ import_react.createElement("path", _extends$40({}, filterProps(props, true), {
...
*/
//#endregion
//#region node_modules/es-toolkit/dist/predicate/isPlainObject.js
...
//#endregion
//#region node_modules/es-toolkit/dist/predicate/isEqualWith.js
var require_isEqualWith = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
	var isPlainObject = require_isPlainObject$2();
	var getSymbols = require_getSymbols();
	var getTag = require_getTag();
	var tags = require_tags();
	var eq = require_eq();
	...
	function areObjectsEqual(a, b, stack, areValuesEqual) {
		...
		switch (aTag) {
			case tags.stringTag: return a.toString() === b.toString();
			case tags.numberTag: {
				const x = a.valueOf();
				const y = b.valueOf();
				return eq.eq(x, y);
			...
			case tags.booleanTag:
			case tags.dateTag:
			case tags.symbolTag: return Object.is(a.valueOf(), b.valueOf());
			case tags.regexpTag: return a.source === b.source && a.flags === b.flags;
			case tags.functionTag: return a === b;
		}
		...
		try {
			switch (aTag) {
				...
				case tags.dataViewTag:
					...
					return areObjectsEqual(new Uint8Array(a), new Uint8Array(b), stack, areValuesEqual);
				case tags.errorTag: return a.name === b.name && a.message === b.message;
				case tags.objectTag: {
					if (!(areObjectsEqual(a.constructor, b.constructor, stack, areValuesEqual) || isPlainObject.isPlainObject(a) && isPlainObject.isPlainObject(b))) return false;
...
//#endregion
//#region node_modules/es-toolkit/dist/function/noop.js
...
//#endregion
//#region node_modules/es-toolkit/dist/predicate/isEqual.js
var require_isEqual$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
...
var import_isEqual = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_isEqual$1().isEqual;
})))());
/**
...
function createStepperUpdate(from, to, easing, interKeys, render, timeoutController) {
	...
	var stepperUpdate = (now) => {
		...
		render(_objectSpread$47(_objectSpread$47(_objectSpread$47({}, from), to), getCurrStyle()));
		preTime = now;
...
function createTimingUpdate(from, to, easing, duration, interKeys, render, timeoutController) {
	var stopAnimation = null;
	var timingStyle = interKeys.reduce((res, key) => _objectSpread$47(_objectSpread$47({}, res), {}, { [key]: [from[key], to[key]] }), {});
	var beginTime;
	var timingUpdate = (now) => {
		if (!beginTime) beginTime = now;
		var t = (now - beginTime) / duration;
		var currStyle = mapObject((key, val) => alpha(...val, easing(t)), timingStyle);
		render(_objectSpread$47(_objectSpread$47(_objectSpread$47({}, from), to), currStyle));
		if (t < 1) stopAnimation = timeoutController.setTimeout(timingUpdate);
			...
			render(_objectSpread$47(_objectSpread$47(_objectSpread$47({}, from), to), finalStyle));
		}
	};
	return () => {
...
//#endregion
//#region node_modules/recharts/es6/animation/Animate.js
var _excluded$29 = [
	"children",
	"begin",
	"duration",
...
var AnimateImpl = class extends import_react.PureComponent {
	constructor(props, context) {
		super(props, context);
		_defineProperty$50(this, "mounted", false);
		_defineProperty$50(this, "manager", null);
		_defineProperty$50(this, "stopJSAnimation", null);
		_defineProperty$50(this, "unSubscribe", null);
		...
		if (!isActive || duration <= 0) {
			this.state = { style: {} };
			if (typeof children === "function") this.state = { style: to };
			return;
		}
		if (from) {
			...
			this.state = { style: attributeName ? { [attributeName]: from } : from };
	...
	componentDidUpdate(prevProps) {
		...
		if (!canBegin) return;
		if (!isActive) {
			var newState = { style: attributeName ? { [attributeName]: to } : to };
			if (this.state && style) {
				if (attributeName && style[attributeName] !== to || !attributeName && style !== to) this.setState(newState);
			}
			return;
		}
		if ((0, import_isEqual.default)(prevProps.to, to) && prevProps.canBegin && prevProps.isActive) return;
		var isTriggered = !prevProps.canBegin || !prevProps.isActive;
		this.manager.stop();
		if (this.stopJSAnimation) this.stopJSAnimation();
		var from = isTriggered || shouldReAnimate ? currentFrom : prevProps.to;
		if (this.state && style) {
			var _newState = { style: attributeName ? { [attributeName]: from } : from };
			if (attributeName && style[attributeName] !== from || !attributeName && style !== from) this.setState(_newState);
		}
		this.runAnimation(_objectSpread$46(_objectSpread$46({}, this.props), {}, {
			from,
			begin: 0
		}));
	}
	...
	runAnimation(props) {
		...
		var to = attributeName ? { [attributeName]: propsTo } : propsTo;
		var transition = getTransitionVal(Object.keys(to), duration, easing);
		this.manager.start([
			onAnimationStart,
			begin,
			_objectSpread$46(_objectSpread$46({}, to), {}, { transition }),
			duration,
			onAnimationEnd
		]);
	}
	render() {
		var _this$props = this.props, { children, begin, duration, attributeName, easing, isActive, from, to, canBegin, onAnimationEnd, shouldReAnimate, onAnimationReStart, animationManager } = _this$props, others = _objectWithoutProperties$29(_this$props, _excluded$29);
		...
		var cloneContainer = (container) => {
			...
			return /* @__PURE__ */ (0, import_react.cloneElement)(container, _objectSpread$46(_objectSpread$46({}, others), {}, {
				style: _objectSpread$46(_objectSpread$46({}, style), stateStyle),
				className
			}));
		};
		if (count === 1) return cloneContainer(import_react.Children.only(children));
		return /* @__PURE__ */ import_react.createElement("div", null, import_react.Children.map(children, (child) => cloneContainer(child)));
	}
};
_defineProperty$50(AnimateImpl, "displayName", "Animate");
_defineProperty$50(AnimateImpl, "defaultProps", {
	begin: 0,
	duration: 1e3,
	attributeName: "",
	easing: "ease",
...
var AnimationManagerContext = /* @__PURE__ */ (0, import_react.createContext)(null);
function Animate(props) {
	var _ref, _props$animationManag;
	var contextAnimationManager = (0, import_react.useContext)(AnimationManagerContext);
	return /* @__PURE__ */ import_react.createElement(AnimateImpl, _extends$39({}, props, { animationManager: (_ref = (_props$animationManag = props.animationManager) !== null && _props$animationManag !== void 0 ? _props$animationManag : contextAnimationManager) !== null && _ref !== void 0 ? _ref : createDefaultAnimationManager() }));
}
//#endregion
...
var Rectangle = (rectangleProps) => {
	var props = resolveDefaultProps(rectangleProps, defaultProps$8);
	...
	return /* @__PURE__ */ import_react.createElement(Animate, {
		...
		}, /* @__PURE__ */ import_react.createElement("path", _extends$38({}, filterProps(props, true), {
			className: layerClass,
...
var Sector = (sectorProps) => {
	var props = resolveDefaultProps(sectorProps, defaultProps$7);
...
function getTickValuesFixedDomainFn(_ref3, tickCount) {
	...
	var values = [...rangeStep(new import_decimal.default(cormin), new import_decimal.default(cormax).sub(new import_decimal.default(.99).mul(step)), step), cormax];
	return min > max ? reverse(values) : values;
}
...
var combineStackGroups = (displayedData, items, stackOffsetType) => {
	...
	return Object.fromEntries(Object.entries(itemsGroup).map((_ref2) => {
		...
		return [stackId, {
			stackedData: getStackedData(displayedData, graphicalItems.map((i) => i.dataKey), stackOffsetType),
			graphicalItems
		}];
	}));
};
...
var combineAxisDomain = (axisSettings, layout, displayedData, allAppliedValues, stackOffsetType, axisType, numericalDomain) => {
	if (axisSettings == null || displayedData == null || displayedData.length === 0) return;
	var { dataKey, type } = axisSettings;
	var isCategorical = isCategoricalAxis(layout, axisType);
	if (isCategorical && dataKey == null) return (0, import_range.default)(0, displayedData.length);
...
var combineNiceTicks = (axisDomain, axisSettings, realScaleType) => {
	...
	if (axisSettings != null && axisSettings.tickCount && axisSettings.type === "number" && axisDomain != null) return getTickValuesFixedDomain(axisDomain, axisSettings.tickCount, axisSettings.allowDecimals);
};
...
}), selectChartLayout, selectBarCategoryGap, selectChartOffset, (_1, _2, _3, padding) => padding, (smallestDistanceInPercent, layout, barCategoryGap, offset, padding) => {
...
var selectXAxisPosition = (state, axisId) => {
	var offset = selectChartOffset(state);
	var axisSettings = selectXAxisSettings(state, axisId);
	if (axisSettings == null) return;
	var stepOfThisAxis = selectAllXAxesOffsetSteps(state, axisSettings.orientation, axisSettings.mirror)[axisId];
...
var selectYAxisPosition = (state, axisId) => {
	...
	if (axisSettings == null) return;
	var stepOfThisAxis = selectAllYAxesOffsetSteps(state, axisSettings.orientation, axisSettings.mirror)[axisId];
	if (stepOfThisAxis == null) return {
		x: 0,
		y: offset.top
	};
...
var selectZAxisWithScale = createSelector((state, _axisType, axisId) => selectZAxisSettings(state, axisId), createSelector([
	selectBaseAxis,
	selectRealScaleType,
	selectAxisDomain,
	selectAxisRangeWithReverse
...
var combineTooltipPayload = (tooltipPayloadConfigurations, activeIndex, chartDataState, tooltipAxis, activeLabel, tooltipPayloadSearcher, tooltipEventType) => {
	...
	return tooltipPayloadConfigurations.reduce((agg, _ref) => {
		...
		var sliced = getSliced(selectFinalData(dataDefinedOnItem, chartData), dataStartIndex, dataEndIndex);
		...
		var tooltipPayload;
		if (tooltipAxis !== null && tooltipAxis !== void 0 && tooltipAxis.dataKey && !(tooltipAxis !== null && tooltipAxis !== void 0 && tooltipAxis.allowDuplicatedCategory) && Array.isArray(sliced) && tooltipEventType === "axis") tooltipPayload = findEntryInArray(sliced, tooltipAxis.dataKey, activeLabel);
		...
		if (Array.isArray(tooltipPayload)) tooltipPayload.forEach((item) => {
			var newSettings = _objectSpread$42(_objectSpread$42({}, settings), {}, {
				name: item.name,
				unit: item.unit,
				color: void 0,
				fill: void 0
...
function Tooltip(outsideProps) {
	...
	var { activeIndex, isActive } = useAppSelector((state) => selectIsTooltipActive(state, tooltipEventType, trigger, defaultIndexAsString));
...
var ResponsiveContainer = /* @__PURE__ */ (0, import_react.forwardRef)((_ref, ref) => {
	var { aspect, initialDimension = {
		width: -1,
		height: -1
	}, width = "100%", height = "100%", minWidth = 0, minHeight, maxHeight, children, debounce = 0, id, className, onResize, style = {} } = _ref;
...
function removeInvalidKeys(obj) {
	var copyObj = _objectSpread$38({}, obj);
...
var getStringSize = function getStringSize(text) {
	...
	try {
		...
		var measurementSpanStyle = _objectSpread$38(_objectSpread$38({}, SPAN_STYLE), copyStyle);
...
var calculateWordsByLines = (_ref2, initialWordsWithComputedWith, spaceWidth, lineWidth, scaleToFit) => {
	...
	var calculate = function calculate() {
		return (arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : []).reduce((result, _ref3) => {
...
var Text = /* @__PURE__ */ (0, import_react.forwardRef)((_ref5, ref) => {
	var { x: propsX = 0, y: propsY = 0, lineHeight = "1em", capHeight = "0.71em", scaleToFit = false, textAnchor = "start", verticalAnchor = "end", fill = DEFAULT_FILL } = _ref5, props = _objectWithoutProperties$28(_ref5, _excluded$28);
	...
	var { dx, dy, angle, className, breakAll } = props, textProps = _objectWithoutProperties$28(props, _excluded2$11);
...
var getAttrsOfCartesianLabel = (props) => {
	...
	if (position === "top") return _objectSpread$37(_objectSpread$37({}, {
		x: x + width / 2,
	...
	if (position === "bottom") return _objectSpread$37(_objectSpread$37({}, {
		x: x + width / 2,
	...
	if (position === "insideLeft") return _objectSpread$37({
		x: x + horizontalOffset,
		y: y + height / 2,
		textAnchor: horizontalStart,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideRight") return _objectSpread$37({
		x: x + width - horizontalOffset,
		y: y + height / 2,
		textAnchor: horizontalEnd,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideTop") return _objectSpread$37({
		x: x + width / 2,
		y: y + verticalOffset,
		textAnchor: "middle",
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottom") return _objectSpread$37({
		x: x + width / 2,
		y: y + height - verticalOffset,
		textAnchor: "middle",
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideTopLeft") return _objectSpread$37({
		x: x + horizontalOffset,
		y: y + verticalOffset,
		textAnchor: horizontalStart,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideTopRight") return _objectSpread$37({
		x: x + width - horizontalOffset,
		y: y + verticalOffset,
		textAnchor: horizontalEnd,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottomLeft") return _objectSpread$37({
		x: x + horizontalOffset,
		y: y + height - verticalOffset,
		textAnchor: horizontalStart,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideBottomRight") return _objectSpread$37({
		x: x + width - horizontalOffset,
		y: y + height - verticalOffset,
		textAnchor: horizontalEnd,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (!!position && typeof position === "object" && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$37({
...
function Label(_ref) {
	var { offset = 5 } = _ref, restProps = _objectWithoutProperties$27(_ref, _excluded$27);
	var props = _objectSpread$37({ offset }, restProps);
...
var renderCallByParent$1 = function renderCallByParent(parentProps, viewBox) {
	...
	return [parseLabel(parentProps.label, viewBox || parentViewBox, labelRef), ...explicitChildren];
};
...
var _excluded$26 = ["valueAccessor"], _excluded2$10 = [
	"data",
	"dataKey",
	"clockWise",
	"id",
...
function LabelList(_ref) {
	var { valueAccessor = defaultAccessor } = _ref, restProps = _objectWithoutProperties$26(_ref, _excluded$26);
	var { data, dataKey, clockWise, id, textBreakAll } = restProps, others = _objectWithoutProperties$26(restProps, _excluded2$10);
	if (!data || !data.length) return null;
	return /* @__PURE__ */ import_react.createElement(Layer, { className: "recharts-label-list" }, data.map((entry, index) => {
		...
		return /* @__PURE__ */ import_react.createElement(Label, _extends$33({}, filterProps(entry, true), others, idProps, {
			...
			value,
			textBreakAll,
			viewBox: Label.parseViewBox(isNullish(clockWise) ? entry : _objectSpread$36(_objectSpread$36({}, entry), {}, { clockWise })),
			key: "label-".concat(index),
			index
		}));
	}));
...
function parseLabelList(label, data) {
	...
	if (typeof label === "object") return /* @__PURE__ */ import_react.createElement(LabelList, _extends$33({ data }, label, { key: "labelList-implicit" }));
	return null;
}
function renderCallByParent(parentProps, data) {
	...
	var explicitChildren = findAllByType(children, LabelList).map((child, index) => /* @__PURE__ */ (0, import_react.cloneElement)(child, {
		data,
		key: "labelList-".concat(index)
	}));
	if (!checkPropsLabel) return explicitChildren;
	return [parseLabelList(parentProps.label, data), ...explicitChildren];
}
...
function Customized(_ref) {
	var { component } = _ref, props = _objectWithoutProperties$25(_ref, _excluded$25);
	var child;
...
var Polygon = (props) => {
	var { points, className, baseLinePoints, connectNulls } = props, others = _objectWithoutProperties$24(props, _excluded$24);
...
var Dot = (props) => {
	...
	if (cx === +cx && cy === +cy && r === +r) return /* @__PURE__ */ import_react.createElement("circle", _extends$31({}, filterProps(props, false), adaptEventHandlers(props), {
		className: layerClass,
		cx,
		cy,
		r
...
var PolarAngles = (props) => {
	...
	var polarAnglesProps = _objectSpread$35({ stroke: "#ccc" }, filterProps(props, false));
...
var ConcentricCircle = (props) => {
	...
	var concentricCircleProps = _objectSpread$35(_objectSpread$35({ stroke: "#ccc" }, filterProps(props, false)), {}, { fill: "none" });
...
var ConcentricPolygon = (props) => {
	...
	var concentricPolygonProps = _objectSpread$35(_objectSpread$35({ stroke: "#ccc" }, filterProps(props, false)), {}, { fill: "none" });
...
var ConcentricGridPath = (props) => {
	...
	return /* @__PURE__ */ import_react.createElement("g", { className: "recharts-polar-grid-concentric" }, polarRadius.map((entry, i) => {
		var key = i;
...
var PolarGrid = (_ref) => {
	...
	var { gridType = "polygon", radialLines = true, angleAxisId = 0, radiusAxisId = 0, cx: cxFromOutside, cy: cyFromOutside, innerRadius: innerRadiusFromOutside, outerRadius: outerRadiusFromOutside } = _ref, inputs = _objectWithoutProperties$23(_ref, _excluded$23);
	...
	return /* @__PURE__ */ import_react.createElement("g", { className: "recharts-polar-grid" }, /* @__PURE__ */ import_react.createElement(PolarAngles, _extends$30({
		cx,
		cy,
		innerRadius,
		outerRadius,
		...
		polarAngles,
		polarRadius
	})), /* @__PURE__ */ import_react.createElement(ConcentricGridPath, _extends$30({
		cx,
		cy,
		innerRadius,
		outerRadius,
...
var getViewBox = (angle, cx, cy, ticks) => {
	...
	return {
		...
		startAngle: angle,
		endAngle: angle,
		innerRadius: (0, import_minBy.default)(ticks, (entry) => entry.coordinate || 0).coordinate || 0,
		outerRadius: maxRadiusTick.coordinate || 0
	};
};
var renderAxisLine = (props, ticks) => {
	var { cx, cy, angle, axisLine } = props, others = _objectWithoutProperties$22(props, _excluded$22);
	...
	var axisLineProps = _objectSpread$34(_objectSpread$34(_objectSpread$34({}, filterProps(others, false)), {}, { fill: "none" }, filterProps(axisLine, false)), {}, {
		x1: point0.x,
		y1: point0.y,
		x2: point1.x,
		y2: point1.y
...
var renderTicks = (props, ticks) => {
	var { angle, tickFormatter, stroke, tick } = props, others = _objectWithoutProperties$22(props, _excluded2$9);
	...
	var items = ticks.map((entry, i) => {
		...
		var tickProps = _objectSpread$34(_objectSpread$34(_objectSpread$34(_objectSpread$34({
			textAnchor,
...
var PolarRadiusAxisWrapper = (defaultsAndInputs) => {
	...
	if (viewBox == null || !ticks || !ticks.length) return null;
	...
	return /* @__PURE__ */ import_react.createElement(Layer, { className: clsx("recharts-polar-radius-axis", AXIS_TYPE$1, props.className) }, axisLine && renderAxisLine(props, ticks), tick && renderTicks(props, ticks), Label.renderCallByParent(props, getViewBox(props.angle, props.cx, props.cy, ticks)));
};
...
_defineProperty$38(PolarRadiusAxis, "displayName", "PolarRadiusAxis");
_defineProperty$38(PolarRadiusAxis, "axisType", AXIS_TYPE$1);
_defineProperty$38(PolarRadiusAxis, "defaultProps", defaultPolarRadiusAxisProps);
//#endregion
...
var AxisLine = (props) => {
	...
	var axisLineProps = _objectSpread$33(_objectSpread$33({}, filterProps(props, false)), {}, { fill: "none" }, filterProps(axisLine, false));
...
var Ticks = (props) => {
	...
	var customTickProps = filterProps(tick, false);
	var tickLineProps = _objectSpread$33(_objectSpread$33({}, axisProps), {}, { fill: "none" }, filterProps(tickLine, false));
	var items = ticks.map((entry, i) => {
		var lineCoord = getTickLineCoord(entry, props);
		var tickProps = _objectSpread$33(_objectSpread$33(_objectSpread$33({ textAnchor: getTickTextAnchor(entry, props.orientation) }, axisProps), {}, {
			stroke: "none",
			fill: stroke
		}, customTickProps), {}, {
			index: i,
...
var PolarAngleAxisWrapper = (defaultsAndInputs) => {
	...
	if (viewBox == null || !ticks || !ticks.length) return null;
	var props = _objectSpread$33(_objectSpread$33(_objectSpread$33({}, defaultsAndInputs), {}, { scale }, viewBox), {}, { radius: viewBox.outerRadius });
	return /* @__PURE__ */ import_react.createElement(Layer, { className: clsx("recharts-polar-angle-axis", AXIS_TYPE, props.className) }, /* @__PURE__ */ import_react.createElement(AxisLine, _extends$28({}, props, { ticks })), /* @__PURE__ */ import_react.createElement(Ticks, _extends$28({}, props, { ticks })));
};
var PolarAngleAxis = class extends import_react.PureComponent {
	render() {
		if (this.props.radius <= 0) return null;
		return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(SetAngleAxisSettings, {
...
_defineProperty$37(PolarAngleAxis, "displayName", "PolarAngleAxis");
_defineProperty$37(PolarAngleAxis, "axisType", AXIS_TYPE);
_defineProperty$37(PolarAngleAxis, "defaultProps", defaultPolarAngleAxisProps);
//#endregion
...
var emptyArray = [];
var pickCells$3 = (_state, _pieSettings, cells) => {
...
var selectDisplayedData = createSelector([
	...
	if ((!displayedData || !displayedData.length) && cells != null) displayedData = cells.map((cell) => _objectSpread$32(_objectSpread$32({}, pieSettings.presentationProps), cell.props));
...
var selectPieSectors = createSelector([
	selectDisplayedData,
	createSelector([selectUnfilteredPolarItems, pickPieSettings], (graphicalItems, pieSettingsFromProps) => {
		if (graphicalItems.some((pgis) => pgis.type === "pie" && pieSettingsFromProps.dataKey === pgis.dataKey && pieSettingsFromProps.data === pgis.data)) return pieSettingsFromProps;
	}),
	pickCells$3,
	selectChartOffset
...
function SetCartesianGraphicalItem(props) {
	var dispatch = useAppDispatch();
	(0, import_react.useEffect)(() => {
		var settings = _objectSpread$31(_objectSpread$31({}, props), {}, { stackId: getNormalizedStackId(props.stackId) });
...
var Trapezoid = (props) => {
	var trapezoidProps = resolveDefaultProps(props, defaultProps$6);
	...
	return /* @__PURE__ */ import_react.createElement(Animate, {
		...
		return /* @__PURE__ */ import_react.createElement(Animate, {
			...
			duration: animationDuration,
			easing: animationEasing
		}, /* @__PURE__ */ import_react.createElement("path", _extends$27({}, filterProps(trapezoidProps, true), {
			className: layerClass,
...
function defaultPropTransformer(option, props) {
	return _objectSpread$30(_objectSpread$30({}, props), option);
}
...
function Shape(_ref2) {
	...
	var shape;
	if (/* @__PURE__ */ (0, import_react.isValidElement)(option)) shape = /* @__PURE__ */ (0, import_react.cloneElement)(option, _objectSpread$30(_objectSpread$30({}, props), getPropsFromShapeOption(option)));
...
function SetPiePayloadLegend(props) {
	var presentationProps = (0, import_react.useMemo)(() => filterProps(props, false), [props]);
	var cells = (0, import_react.useMemo)(() => findAllByType(props.children, Cell), [props.children]);
	var pieSettings = (0, import_react.useMemo)(() => ({
		name: props.name,
...
var getOuterRadius = (dataPoint, outerRadius, maxPieRadius) => {
	if (typeof outerRadius === "function") return outerRadius(dataPoint);
...
var parseCoordinateOfPie = (item, offset, dataPoint) => {
	...
	return {
		cx: left + getPercentValue(item.cx, width, width / 2),
		cy: top + getPercentValue(item.cy, height, height / 2),
		innerRadius: getPercentValue(item.innerRadius, maxPieRadius, 0),
		outerRadius: getOuterRadius(dataPoint, item.outerRadius, maxPieRadius),
		maxRadius: item.maxRadius || Math.sqrt(width * width + height * height) / 2
	};
};
...
function PieLabels(_ref) {
	...
	var labels = sectors.map((entry, i) => {
		...
		var labelProps = _objectSpread$29(_objectSpread$29(_objectSpread$29(_objectSpread$29({}, pieProps), entry), {}, { stroke: "none" }, customLabelProps), {}, {
			index: i,
			textAnchor: getTextAnchor(endPoint.x, entry.cx)
		}, endPoint);
		var lineProps = _objectSpread$29(_objectSpread$29(_objectSpread$29(_objectSpread$29({}, pieProps), entry), {}, {
			fill: "none",
			stroke: entry.fill
...
function PieSectors(props) {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, sectors.map((entry, i) => {
		...
		var sectorProps = _objectSpread$29(_objectSpread$29({}, entry), {}, {
			stroke: entry.stroke,
			tabIndex: -1,
	...
	}), /* @__PURE__ */ import_react.createElement(PieLabels, {
		sectors,
...
function computePieSectors(_ref2) {
	...
	if (sum > 0) {
		...
		sectors = displayedData.map((entry, i) => {
			...
			var tempStartAngle;
			var entryWithCellInfo = _objectSpread$29(_objectSpread$29({}, entry), cells && cells[i] && cells[i].props);
			...
			prev = _objectSpread$29(_objectSpread$29(_objectSpread$29(_objectSpread$29({}, pieSettings.presentationProps), {}, {
				percent,
				cornerRadius,
				name,
				tooltipPayload,
...
function SectorsWithAnimation$1(_ref3) {
	...
	var [isAnimating, setIsAnimating] = (0, import_react.useState)(true);
	...
	return /* @__PURE__ */ import_react.createElement(Animate, {
		...
		sectors.forEach((entry, index) => {
			...
			if (prev) {
				...
				var latest = _objectSpread$29(_objectSpread$29({}, entry), {}, {
				...
				var _latest = _objectSpread$29(_objectSpread$29({}, entry), {}, {
					startAngle: curAngle + paddingAngle,
...
function RenderSectors$1(props) {
	...
	var prevSectors = previousSectorsRef.current;
	if (isAnimationActive && sectors && sectors.length && (!prevSectors || prevSectors !== sectors)) return /* @__PURE__ */ import_react.createElement(SectorsWithAnimation$1, {
		props,
		previousSectorsRef
	});
	return /* @__PURE__ */ import_react.createElement(PieSectors, {
		sectors,
		activeShape,
		inactiveShape,
		allOtherPieProps: props,
...
function PieWithTouchMove(props) {
	...
	return /* @__PURE__ */ import_react.createElement(Layer, {
		...
		className: layerClass
	}, /* @__PURE__ */ import_react.createElement(RenderSectors$1, props));
}
var defaultPieProps = {
	animationBegin: 400,
	animationDuration: 1500,
...
function PieImpl(props) {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(SetTooltipEntrySettings, {
		...
		args: _objectSpread$29(_objectSpread$29({}, propsWithDefaults), {}, { sectors })
	}), /* @__PURE__ */ import_react.createElement(PieWithTouchMove, _extends$26({}, propsWithDefaults, { sectors })));
}
var Pie = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty$33(this, "id", uniqueId("recharts-pie-"));
	}
	render() {
		return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(SetPolarGraphicalItem, {
			...
			barSize: void 0,
			type: "pie"
		}), /* @__PURE__ */ import_react.createElement(SetPiePayloadLegend, this.props), /* @__PURE__ */ import_react.createElement(PieImpl, this.props), this.props.children);
	}
};
_defineProperty$33(Pie, "displayName", "Pie");
_defineProperty$33(Pie, "defaultProps", defaultPieProps);
//#endregion
...
function ActivePoints(_ref2) {
	...
	var activeLabel = useAppSelector(selectActiveLabel$1);
	if (!activeTooltipIndex) return null;
	var activePoint;
	var tooltipAxisDataKey = tooltipAxis.dataKey;
	if (tooltipAxisDataKey && !tooltipAxis.allowDuplicatedCategory) activePoint = findEntryInArray(points, typeof tooltipAxisDataKey === "function" ? (point) => tooltipAxisDataKey(point.payload) : "payload.".concat(tooltipAxisDataKey), activeLabel);
	else activePoint = points === null || points === void 0 ? void 0 : points[Number(activeTooltipIndex)];
...
//#endregion
//#region node_modules/recharts/es6/context/PolarGraphicalItemContext.js
var PolarGraphicalItemContext = (props) => {
	return /* @__PURE__ */ import_react.createElement(SetPolarGraphicalItem, props);
};
//#endregion
...
var selectRadarPoints = createSelector([
	...
	selectChartDataAndAlwaysIgnoreIndexes,
	createSelector([selectUnfilteredPolarItems, pickDataKey], (graphicalItems, radarDataKey) => {
		if (graphicalItems.some((pgis) => pgis.type === "radar" && radarDataKey === pgis.dataKey)) return radarDataKey;
	}),
...
function computeRadarPoints(_ref) {
	...
	if (isRange) points.forEach((point) => {
		if (Array.isArray(point.value)) {
			...
			baseLinePoints.push(_objectSpread$26(_objectSpread$26({}, point), {}, { radius }, polarToCartesian(cx, cy, radius, point.angle)));
...
function Dots$2(_ref2) {
	...
	var dots = points.map((entry, i) => {
		return renderDotItem$2(dot, _objectSpread$26(_objectSpread$26(_objectSpread$26({
			key: "dot-".concat(i),
			r: 3
...
function RenderPolygon(props) {
	...
	var prevPoints = previousPointsRef.current;
	if (isAnimationActive && points && points.length && !isRange && (!prevPoints || prevPoints !== points)) return /* @__PURE__ */ import_react.createElement(PolygonWithAnimation, {
		props,
		previousPointsRef
	});
	return /* @__PURE__ */ import_react.createElement(StaticPolygon, {
...
var Radar = class extends import_react.PureComponent {
	render() {
		return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(PolarGraphicalItemContext, {
			data: void 0,
			dataKey: this.props.dataKey,
			hide: this.props.hide,
			...
			args: this.props
		}), /* @__PURE__ */ import_react.createElement(RadarImpl, this.props));
	}
};
_defineProperty$30(Radar, "displayName", "Radar");
_defineProperty$30(Radar, "defaultProps", defaultRadarProps);
//#endregion
...
//#endregion
//#region node_modules/recharts/es6/state/ReportBar.js
var ReportBar = () => {
	var dispatch = useAppDispatch();
	(0, import_react.useEffect)(() => {
		dispatch(addBar());
...
//#endregion
//#region node_modules/recharts/es6/context/CartesianGraphicalItemContext.js
...
var noop = () => {};
var ErrorBarDirectionDispatchContext = /* @__PURE__ */ (0, import_react.createContext)({
	addErrorBar: noop,
	removeErrorBar: noop
});
...
function SetErrorBarContext(props) {
	var { children } = props, rest = _objectWithoutProperties$19(props, _excluded$19);
...
var CartesianGraphicalItemContext = (_ref) => {
	...
	var [errorBars, updateErrorBars] = import_react.useState([]);
	var addErrorBar = (0, import_react.useCallback)((errorBar) => {
		updateErrorBars((prev) => [...prev, errorBar]);
	}, [updateErrorBars]);
	var removeErrorBar = (0, import_react.useCallback)((errorBar) => {
		updateErrorBars((prev) => prev.filter((eb) => eb !== errorBar));
	}, [updateErrorBars]);
	var isPanorama = useIsPanorama();
	return /* @__PURE__ */ import_react.createElement(ErrorBarDirectionDispatchContext.Provider, { value: {
		addErrorBar,
		removeErrorBar
...
function ReportErrorBarSettings(props) {
	var { addErrorBar, removeErrorBar } = (0, import_react.useContext)(ErrorBarDirectionDispatchContext);
	(0, import_react.useEffect)(() => {
		addErrorBar(props);
		return () => {
...
function ErrorBarImpl(props) {
	...
	var svgProps = filterProps(_objectWithoutProperties$18(props, _excluded$18), false);
	...
	var errorBars = data.map((entry) => {
		...
		return /* @__PURE__ */ import_react.createElement(Layer, _extends$23({
			...
			var lineStyle = isAnimationActive ? { transformOrigin: "".concat(coordinates.x1 - 5, "px") } : void 0;
			return /* @__PURE__ */ import_react.createElement(Animate, {
				from: {
					transform: "scaleY(0)",
					transformOrigin
			...
			}, /* @__PURE__ */ import_react.createElement("line", _extends$23({}, coordinates, { style: lineStyle })));
		}));
	});
	return /* @__PURE__ */ import_react.createElement(Layer, { className: "recharts-errorBars" }, errorBars);
}
var ErrorBarPreferredDirection = /* @__PURE__ */ (0, import_react.createContext)(void 0);
function useErrorBarDirection(directionFromProps) {
	var preferredDirection = (0, import_react.useContext)(ErrorBarPreferredDirection);
...
function SetErrorBarPreferredDirection(_ref) {
	...
	return /* @__PURE__ */ import_react.createElement(ErrorBarPreferredDirection.Provider, { value: direction }, children);
}
...
function ErrorBarInternal(props) {
	...
	}), /* @__PURE__ */ import_react.createElement(ErrorBarImpl, _extends$23({}, props, {
		direction: realDirection,
		width,
		isAnimationActive,
		animationBegin,
...
_defineProperty$28(ErrorBar, "defaultProps", errorBarDefaultProps);
...
function typeguardBarRectangleProps(_ref, props) {
	var { x: xProp, y: yProp } = _ref, option = _objectWithoutProperties$17(_ref, _excluded$17);
	...
	return _objectSpread$24(_objectSpread$24(_objectSpread$24(_objectSpread$24(_objectSpread$24({}, props), option), x ? { x } : {}), y ? { y } : {}), {}, {
		height,
		width,
		name: props.name,
		radius: props.radius
...
function BarRectangle(props) {
	return /* @__PURE__ */ import_react.createElement(Shape, _extends$22({
		shapeType: "rectangle",
...
function BarBackground(props) {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, data.map((entry, i) => {
		var { value, background: backgroundFromDataEntry, tooltipPosition } = entry, rest = _objectWithoutProperties$16(entry, _excluded2$8);
		...
		return /* @__PURE__ */ import_react.createElement(BarRectangle, _extends$21({ key: "background-bar-".concat(i) }, barRectangleProps));
	}));
}
function BarRectangles(_ref) {
	...
	var { onMouseEnter: onMouseEnterFromProps, onClick: onItemClickFromProps, onMouseLeave: onMouseLeaveFromProps } = props, restOfAllOtherProps = _objectWithoutProperties$16(props, _excluded3$2);
	var onMouseEnterFromContext = useMouseEnterItemDispatch(onMouseEnterFromProps, dataKey);
	var onMouseLeaveFromContext = useMouseLeaveItemDispatch(onMouseLeaveFromProps);
	var onClickFromContext = useMouseClickItemDispatch(onItemClickFromProps, dataKey);
	if (!data) return null;
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, data.map((entry, i) => {
		...
		var barRectangleProps = _objectSpread$23(_objectSpread$23(_objectSpread$23({}, baseProps), entry), {}, {
			isActive,
			option,
			index: i,
			dataKey
		});
		return /* @__PURE__ */ import_react.createElement(Layer, _extends$21({ className: "recharts-bar-rectangle" }, adaptEventsOfChild(restOfAllOtherProps, entry, i), {
			onMouseEnter: onMouseEnterFromContext(entry, i),
			onMouseLeave: onMouseLeaveFromContext(entry, i),
			onClick: onClickFromContext(entry, i),
			key: "rectangle-".concat(entry === null || entry === void 0 ? void 0 : entry.x, "-").concat(entry === null || entry === void 0 ? void 0 : entry.y, "-").concat(entry === null || entry === void 0 ? void 0 : entry.value, "-").concat(i)
		}), /* @__PURE__ */ import_react.createElement(BarRectangle, barRectangleProps));
...
function RectanglesWithAnimation(_ref2) {
	...
	return /* @__PURE__ */ import_react.createElement(Animate, {
		...
		if (t > 0) previousRectanglesRef.current = stepData;
...
function RenderRectangles(props) {
	...
	if (isAnimationActive && data && data.length && (previousRectanglesRef.current == null || previousRectanglesRef.current !== data)) return /* @__PURE__ */ import_react.createElement(RectanglesWithAnimation, {
		previousRectanglesRef,
		props
	});
	return /* @__PURE__ */ import_react.createElement(BarRectangles, {
		props,
		data,
		showLabels: true
	});
...
var BarWithState = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty$26(this, "id", uniqueId("recharts-bar-"));
	}
	render() {
		...
		return /* @__PURE__ */ import_react.createElement(Layer, { className: layerClass }, needClip && /* @__PURE__ */ import_react.createElement("defs", null, /* @__PURE__ */ import_react.createElement(GraphicalItemClipPath, {
			clipPathId,
			xAxisId,
			yAxisId
		...
		}), /* @__PURE__ */ import_react.createElement(RenderRectangles, this.props)), /* @__PURE__ */ import_react.createElement(SetErrorBarPreferredDirection, { direction: layout === "horizontal" ? "y" : "x" }, this.props.children));
	}
};
var defaultBarProps = {
	activeBar: false,
...
function BarImpl(props) {
	var { xAxisId, yAxisId, hide, legendType, minPointSize, activeBar, animationBegin, animationDuration, animationEasing, isAnimationActive } = resolveDefaultProps(props, defaultBarProps);
	var { needClip } = useNeedsClip(xAxisId, yAxisId);
	var layout = useChartLayout();
	var isPanorama = useIsPanorama();
	var barSettings = (0, import_react.useMemo)(() => ({
	...
	return /* @__PURE__ */ import_react.createElement(SetErrorBarContext, {
		...
		errorBarOffset
	}, /* @__PURE__ */ import_react.createElement(BarWithState, _extends$21({}, props, {
		layout,
		needClip,
		data: rects,
		xAxisId,
...
function computeBarRectangles(_ref4) {
	var { layout, barSettings: { dataKey, minPointSize: minPointSizeProp }, pos, bandSize, xAxis, yAxis, xAxisTicks, yAxisTicks, stackedData, dataStartIndex, displayedData, offset, cells } = _ref4;
...
var Bar = class extends import_react.PureComponent {
	render() {
		return /* @__PURE__ */ import_react.createElement(CartesianGraphicalItemContext, {
			type: "bar",
			data: null,
		...
		}, /* @__PURE__ */ import_react.createElement(ReportBar, null), /* @__PURE__ */ import_react.createElement(SetLegendPayload, { legendPayload: computeLegendPayloadFromBarData(this.props) }), /* @__PURE__ */ import_react.createElement(SetTooltipEntrySettings, {
			fn: getTooltipEntrySettings$8,
			args: this.props
		}), /* @__PURE__ */ import_react.createElement(BarImpl, this.props));
	}
};
_defineProperty$26(Bar, "displayName", "Bar");
_defineProperty$26(Bar, "defaultProps", defaultBarProps);
//#endregion
...
var pickMaxBarSize$1 = (_state, _xAxisId, _yAxisId, _isPanorama, barSettings) => barSettings.maxBarSize;
var pickCells$2 = (_state, _xAxisId, _yAxisId, _isPanorama, _barSettings, cells) => cells;
...
var selectBarStackGroups = (state, xAxisId, yAxisId, isPanorama) => {
	if (selectChartLayout(state) === "horizontal") return selectStackGroups$1(state, "yAxis", yAxisId, isPanorama);
...
var selectBarPosition = createSelector([selectAllBarPositions, pickBarSettings], (allBarPositions, barSettings) => {
	if (allBarPositions == null) return;
...
var combineStackedData = (stackGroups, barSettings) => {
	if (!stackGroups || (barSettings === null || barSettings === void 0 ? void 0 : barSettings.dataKey) == null) return;
...
var selectSynchronisedBarSettings = createSelector([selectUnfilteredCartesianItems, pickBarSettings], (graphicalItems, barSettingsFromProps) => {
	if (graphicalItems.some((cgis) => cgis.type === "bar" && barSettingsFromProps.dataKey === cgis.dataKey && barSettingsFromProps.stackId === cgis.stackId && barSettingsFromProps.stackId === cgis.stackId)) return barSettingsFromProps;
});
var selectBarRectangles = createSelector([
	...
	selectAxisBandSize,
	createSelector([selectBarStackGroups, pickBarSettings], combineStackedData),
	...
	if (barSettings == null || pos == null || layout !== "horizontal" && layout !== "vertical" || xAxis == null || yAxis == null || xAxisTicks == null || yAxisTicks == null || bandSize == null) return;
...
var selectPolarBarPosition = createSelector([createSelector([
	...
	pickMaxBarSize
], combineAllBarPositions), selectSynchronisedRadialBarSettings], (allBarPositions, barSettings) => {
...
function RadialBarSectors(_ref) {
	...
	var { shape, activeShape, cornerRadius } = allOtherRadialBarProps, others = _objectWithoutProperties$15(allOtherRadialBarProps, _excluded$15);
	var baseProps = filterProps(others, false);
	var activeIndex = useAppSelector(selectActiveTooltipIndex);
	var { onMouseEnter: onMouseEnterFromProps, onClick: onItemClickFromProps, onMouseLeave: onMouseLeaveFromProps } = allOtherRadialBarProps, restOfAllOtherProps = _objectWithoutProperties$15(allOtherRadialBarProps, _excluded2$7);
...
function RenderSectors(props) {
	...
	var previousSectorsRef = (0, import_react.useRef)(null);
	var prevData = previousSectorsRef.current;
	if (isAnimationActive && data && data.length && (!prevData || prevData !== data)) return /* @__PURE__ */ import_react.createElement(SectorsWithAnimation, {
		props,
		previousSectorsRef
	});
...
var RadialBarWithState = class extends import_react.PureComponent {
	renderBackground(sectors) {
		...
		return sectors.map((entry, i) => {
			var { value, background } = entry, rest = _objectWithoutProperties$15(entry, _excluded3$1);
...
function RadialBarImpl(props) {
	...
	}), /* @__PURE__ */ import_react.createElement(RadialBarWithState, _extends$20({}, props, { data })));
}
...
var RadialBar = class extends import_react.PureComponent {
	render() {
		...
		return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(ReportBar, null), /* @__PURE__ */ import_react.createElement(PolarGraphicalItemContext, {
			data: void 0,
			dataKey: this.props.dataKey,
			...
			barSize: this.props.barSize,
			type: "radialBar"
		}), /* @__PURE__ */ import_react.createElement(SetRadialBarPayloadLegend, this.props), /* @__PURE__ */ import_react.createElement(RadialBarImpl, this.props));
	}
};
_defineProperty$23(RadialBar, "displayName", "RadialBar");
_defineProperty$23(RadialBar, "defaultProps", defaultRadialBarProps);
//#endregion
...
function TravellerLayer(_ref) {
	...
	var travellerProps = _objectSpread$18(_objectSpread$18({}, filterProps(otherProps, false)), {}, {
		x,
		y,
...
function BrushText(_ref4) {
	...
	return /* @__PURE__ */ import_react.createElement(Layer, { className: "recharts-brush-texts" }, /* @__PURE__ */ import_react.createElement(Text, _extends$19({
		textAnchor: "end",
		verticalAnchor: "middle",
		...
		dataKey,
		data
	})), /* @__PURE__ */ import_react.createElement(Text, _extends$19({
		textAnchor: "start",
		verticalAnchor: "middle",
...
var BrushWithState = class extends import_react.PureComponent {
	constructor(props) {
		super(props);
		_defineProperty$21(this, "handleDrag", (e) => {
			if (this.leaveTimer) {
		...
		_defineProperty$21(this, "handleLeaveWrapper", () => {
		...
		_defineProperty$21(this, "handleEnterSlideOrTraveller", () => {
			this.setState({ isTextActive: true });
		});
		_defineProperty$21(this, "handleLeaveSlideOrTraveller", () => {
			this.setState({ isTextActive: false });
		});
		_defineProperty$21(this, "handleSlideDragStart", (e) => {
		...
		_defineProperty$21(this, "handleTravellerMoveKeyboard", (direction, id) => {
...
function BrushInternal(props) {
	...
	var { startIndex, endIndex } = useDataIndex();
	...
	var { x, y, width } = useAppSelector(selectBrushDimensions);
	...
	return /* @__PURE__ */ import_react.createElement(BrushWithState, _extends$19({}, props, contextProperties, {
...
var Brush = class extends import_react.PureComponent {
	render() {
		...
		}), /* @__PURE__ */ import_react.createElement(BrushInternal, this.props));
	}
};
_defineProperty$21(Brush, "displayName", "Brush");
_defineProperty$21(Brush, "defaultProps", {
	height: 40,
	travellerWidth: 5,
	gap: 1,
	fill: "#fff",
...
_defineProperty$20(ScaleHelper, "EPS", 1e-4);
var createLabeledScales = (options) => {
	var scales = Object.keys(options).reduce((res, key) => _objectSpread$17(_objectSpread$17({}, res), {}, { [key]: ScaleHelper.create(options[key]) }), {});
...
var renderLine = (option, props) => {
	...
	else line = /* @__PURE__ */ import_react.createElement("line", _extends$18({}, props, { className: "recharts-reference-line-line" }));
	return line;
};
...
function ReferenceLineImpl(props) {
	...
	var lineProps = _objectSpread$16(_objectSpread$16({ clipPath: ifOverflow === "hidden" ? "url(#".concat(clipPathId, ")") : void 0 }, filterProps(props, true)), {}, {
		x1,
		y1,
		x2,
		y2
...
_defineProperty$19(ReferenceLine, "displayName", "ReferenceLine");
_defineProperty$19(ReferenceLine, "defaultProps", {
	ifOverflow: "discard",
	xAxisId: 0,
	yAxisId: 0,
	fill: "none",
...
var renderDot = (option, props) => {
	...
	else dot = /* @__PURE__ */ import_react.createElement(Dot, _extends$17({}, props, {
		cx: props.cx,
		cy: props.cy,
...
function ReferenceDotImpl(props) {
	...
	var dotProps = _objectSpread$15(_objectSpread$15({ clipPath: ifOverflow === "hidden" ? "url(#".concat(clipPathId, ")") : void 0 }, filterProps(props, true)), {}, {
		cx,
		cy
	});
	return /* @__PURE__ */ import_react.createElement(Layer, { className: clsx("recharts-reference-dot", className) }, renderDot(shape, dotProps), Label.renderCallByParent(props, {
		x: cx - r,
		y: cy - r,
		width: 2 * r,
		height: 2 * r
...
_defineProperty$18(ReferenceDot, "displayName", "ReferenceDot");
_defineProperty$18(ReferenceDot, "defaultProps", {
	ifOverflow: "discard",
	xAxisId: 0,
	yAxisId: 0,
	r: 10,
...
var renderRect = (option, props) => {
	...
	else rect = /* @__PURE__ */ import_react.createElement(Rectangle, _extends$16({}, props, { className: "recharts-reference-area-rect" }));
	return rect;
};
...
function ReferenceAreaImpl(props) {
	...
	return /* @__PURE__ */ import_react.createElement(Layer, { className: clsx("recharts-reference-area", className) }, renderRect(shape, _objectSpread$14(_objectSpread$14({ clipPath }, filterProps(props, true)), rect)), Label.renderCallByParent(props, rect));
}
...
_defineProperty$17(ReferenceArea, "displayName", "ReferenceArea");
_defineProperty$17(ReferenceArea, "defaultProps", {
	ifOverflow: "discard",
	xAxisId: 0,
	yAxisId: 0,
	r: 10,
...
*/
var _excluded$14 = ["viewBox"], _excluded2$6 = ["viewBox"];
...
var CartesianAxis = class CartesianAxis extends import_react.Component {
	constructor(props) {
		super(props);
		this.tickRefs = /* @__PURE__ */ import_react.createRef();
	...
	shouldComponentUpdate(_ref, nextState) {
		var { viewBox } = _ref, restProps = _objectWithoutProperties$14(_ref, _excluded$14);
		var _this$props = this.props, { viewBox: viewBoxOld } = _this$props, restPropsOld = _objectWithoutProperties$14(_this$props, _excluded2$6);
	...
	*/
	...
	static renderTickItem(option, props, value) {
		...
		else if (typeof option === "function") tickItem = option(_objectSpread$12(_objectSpread$12({}, props), {}, { className: combinedClassName }));
		else {
			var className = "recharts-cartesian-axis-tick-value";
			if (typeof option !== "boolean") className = clsx(className, option.className);
			tickItem = /* @__PURE__ */ import_react.createElement(Text, _extends$15({}, props, { className }), value);
		}
		return tickItem;
	}
	/**
	...
	*/
	renderTicks(fontSize, letterSpacing) {
		...
		var items = finalTicks.map((entry, i) => {
			...
			}, adaptEventsOfChild(this.props, entry, i)), tickLine && /* @__PURE__ */ import_react.createElement("line", _extends$15({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", (0, import_get.default)(tickLine, "className")) })), tick && CartesianAxis.renderTickItem(tick, tickProps, "".concat(typeof tickFormatter === "function" ? tickFormatter(entry.value, i) : entry.value).concat(unit || "")));
		});
		return items.length > 0 ? /* @__PURE__ */ import_react.createElement("g", { className: "recharts-cartesian-axis-ticks" }, items) : null;
	}
	render() {
...
var _excluded$13 = [
	...
	"y2",
	"key"
], _excluded2$5 = ["offset"], _excluded3 = ["xAxisId", "yAxisId"], _excluded4 = ["xAxisId", "yAxisId"];
...
function renderLineItem(option, props) {
	...
	if (/* @__PURE__ */ import_react.isValidElement(option)) lineItem = /* @__PURE__ */ import_react.cloneElement(option, props);
		...
		var _filterProps = filterProps(_objectWithoutProperties$13(props, _excluded$13), false), { offset: __ } = _filterProps, restOfFilteredProps = _objectWithoutProperties$13(_filterProps, _excluded2$5);
...
function HorizontalGridLines(props) {
	...
	var { xAxisId, yAxisId } = props, otherLineItemProps = _objectWithoutProperties$13(props, _excluded3);
	var items = horizontalPoints.map((entry, i) => {
		return renderLineItem(horizontal, _objectSpread$11(_objectSpread$11({}, otherLineItemProps), {}, {
			x1: x,
			y1: entry,
			x2: x + width,
			y2: entry,
...
function VerticalGridLines(props) {
	...
	var { xAxisId, yAxisId } = props, otherLineItemProps = _objectWithoutProperties$13(props, _excluded4);
	var items = verticalPoints.map((entry, i) => {
		return renderLineItem(vertical, _objectSpread$11(_objectSpread$11({}, otherLineItemProps), {}, {
			x1: entry,
			y1: y,
			x2: entry,
			y2: y + height,
...
function CartesianGrid(props) {
	...
	var chartHeight = useChartHeight();
	var offset = useOffset();
	var propsIncludingDefaults = _objectSpread$11(_objectSpread$11({}, resolveDefaultProps(props, defaultProps$5)), {}, {
	...
	}), /* @__PURE__ */ import_react.createElement(HorizontalStripes, _extends$14({}, propsIncludingDefaults, { horizontalPoints })), /* @__PURE__ */ import_react.createElement(VerticalStripes, _extends$14({}, propsIncludingDefaults, { verticalPoints })), /* @__PURE__ */ import_react.createElement(HorizontalGridLines, _extends$14({}, propsIncludingDefaults, {
		offset,
		horizontalPoints,
		xAxis,
		yAxis
...
var selectLinePoints = createSelector([
	...
	selectXAxisTicks$2,
	selectYAxisTicks$2,
	createSelector([selectUnfilteredCartesianItems, pickLineSettings], (graphicalItems, lineSettingsFromProps) => {
		if (graphicalItems.some((cgis) => cgis.type === "line" && lineSettingsFromProps.dataKey === cgis.dataKey && lineSettingsFromProps.data === cgis.data)) return lineSettingsFromProps;
	}),
	selectBandSize$1,
	selectChartDataWithIndexesIfNotInPanorama
...
function Dots$1(_ref) {
	...
	var customDotProps = filterProps(dot, true);
	var dots = points.map((entry, i) => {
		return renderDotItem$1(dot, _objectSpread$10(_objectSpread$10(_objectSpread$10({
			key: "dot-".concat(i),
			r: 3
...
function StaticCurve(_ref2) {
	...
	var curveProps = _objectSpread$10(_objectSpread$10({}, filterProps(_objectWithoutProperties$12(props, _excluded$12), true)), {}, {
		fill: "none",
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ import_react.createElement(Curve, _extends$13({}, curveProps, { pathRef })), /* @__PURE__ */ import_react.createElement(Dots$1, {
		points,
		clipPathId,
		props
	}), showLabels && LabelList.renderCallByParent(props, points));
...
function CurveWithAnimation(_ref3) {
	...
	return /* @__PURE__ */ import_react.createElement(Animate, {
		...
		if (strokeDasharray) currentStrokeDasharray = getStrokeDasharray(curLength, totalLength, "".concat(strokeDasharray).split(/[,\s]+/gim).map((num) => parseFloat(num)));
...
function RenderCurve(_ref5) {
	...
	var pathRef = (0, import_react.useRef)(null);
	var prevPoints = previousPointsRef.current;
	if (isAnimationActive && points && points.length && prevPoints !== points) return /* @__PURE__ */ import_react.createElement(CurveWithAnimation, {
		props,
		clipPathId,
		previousPointsRef,
...
var LineWithState = class extends import_react.Component {
	constructor() {
		super(...arguments);
		_defineProperty$13(this, "id", uniqueId("recharts-line-"));
	}
	render() {
		var _filterProps;
		...
		return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(Layer, { className: layerClass }, needClip && /* @__PURE__ */ import_react.createElement("defs", null, /* @__PURE__ */ import_react.createElement(GraphicalItemClipPath, {
			...
			props: this.props,
			clipPathId
		}), /* @__PURE__ */ import_react.createElement(SetErrorBarPreferredDirection, { direction: layout === "horizontal" ? "y" : "x" }, /* @__PURE__ */ import_react.createElement(SetErrorBarContext, {
			xAxisId,
			yAxisId,
			data: points,
			dataPointFormatter: errorBarDataPointFormatter$1,
			errorBarOffset: 0
		}, this.props.children))), /* @__PURE__ */ import_react.createElement(ActivePoints, {
			activeDot: this.props.activeDot,
			points,
...
function LineImpl(props) {
	var _resolveDefaultProps = resolveDefaultProps(props, defaultLineProps), { activeDot, animateNewValues, animationBegin, animationDuration, animationEasing, connectNulls, dot, hide, isAnimationActive, label, legendType, xAxisId, yAxisId } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$12(_resolveDefaultProps, _excluded2$4);
	var { needClip } = useNeedsClip(xAxisId, yAxisId);
	var { height, width, left, top } = useOffset();
	var layout = useChartLayout();
	var isPanorama = useIsPanorama();
	var lineSettings = (0, import_react.useMemo)(() => ({
		dataKey: props.dataKey,
		data: props.data
	...
	return /* @__PURE__ */ import_react.createElement(LineWithState, _extends$13({}, everythingElse, {
		connectNulls,
		dot,
		activeDot,
		animateNewValues,
...
var Line = class extends import_react.PureComponent {
	render() {
		return /* @__PURE__ */ import_react.createElement(CartesianGraphicalItemContext, {
			type: "line",
			data: this.props.data,
			...
			hide: this.props.hide,
			barSize: void 0
		}, /* @__PURE__ */ import_react.createElement(SetLegendPayload, { legendPayload: computeLegendPayloadFromAreaData$1(this.props) }), /* @__PURE__ */ import_react.createElement(SetTooltipEntrySettings, {
			fn: getTooltipEntrySettings$6,
			args: this.props
		}), /* @__PURE__ */ import_react.createElement(LineImpl, this.props));
	}
};
_defineProperty$13(Line, "displayName", "Line");
_defineProperty$13(Line, "defaultProps", defaultLineProps);
//#endregion
...
var selectGraphicalItemStackedData = (state, xAxisId, yAxisId, isPanorama, areaSettings) => {
	...
	var stackGroups;
	if (isXAxisCategorical) stackGroups = selectStackGroups$1(state, "yAxis", yAxisId, isPanorama);
	else stackGroups = selectStackGroups$1(state, "xAxis", xAxisId, isPanorama);
	if (stackGroups == null) return;
...
var selectArea = createSelector([
	...
	selectChartDataWithIndexesIfNotInPanorama,
	selectBandSize,
	createSelector([selectUnfilteredCartesianItems, pickAreaSettings], (graphicalItems, areaSettingsFromProps) => {
		if (graphicalItems.some((cgis) => cgis.type === "area" && areaSettingsFromProps.dataKey === cgis.dataKey && getNormalizedStackId(areaSettingsFromProps.stackId) === cgis.stackId && areaSettingsFromProps.data === cgis.data)) return areaSettingsFromProps;
	})
...
var renderDotItem = (option, props) => {
	...
	if (/* @__PURE__ */ import_react.isValidElement(option)) dotItem = /* @__PURE__ */ import_react.cloneElement(option, props);
		...
		dotItem = /* @__PURE__ */ import_react.createElement(Dot, _extends$12({}, props, { className }));
	}
	return dotItem;
};
...
function Dots(_ref) {
	...
	var customDotProps = filterProps(dot, true);
	var dots = points.map((entry, i) => {
		return renderDotItem(dot, _objectSpread$9(_objectSpread$9(_objectSpread$9({
			key: "dot-".concat(i),
			r: 3
	...
	return /* @__PURE__ */ import_react.createElement(Layer, _extends$12({ className: "recharts-area-dots" }, dotsProps), dots);
}
function StaticArea(_ref2) {
	var { points, baseLine, needClip, clipPathId, props, showLabels } = _ref2;
	var { layout, type, stroke, connectNulls, isRange } = props, others = _objectWithoutProperties$11(props, _excluded$11);
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, (points === null || points === void 0 ? void 0 : points.length) > 1 && /* @__PURE__ */ import_react.createElement(Layer, { clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : void 0 }, /* @__PURE__ */ import_react.createElement(Curve, _extends$12({}, filterProps(others, true), {
		points,
		connectNulls,
		type,
		baseLine,
	...
	})), stroke !== "none" && /* @__PURE__ */ import_react.createElement(Curve, _extends$12({}, filterProps(props, false), {
		...
		fill: "none",
		points
	})), stroke !== "none" && isRange && /* @__PURE__ */ import_react.createElement(Curve, _extends$12({}, filterProps(props, false), {
		className: "recharts-area-curve",
		layout,
		type,
		connectNulls,
...
function AreaWithAnimation(_ref6) {
	...
	return /* @__PURE__ */ import_react.createElement(Animate, {
		...
		return /* @__PURE__ */ import_react.createElement(Layer, null, /* @__PURE__ */ import_react.createElement("defs", null, /* @__PURE__ */ import_react.createElement("clipPath", { id: "animationClipPath-".concat(clipPathId) }, /* @__PURE__ */ import_react.createElement(ClipRect, {
			alpha: t,
			points,
			baseLine,
			layout: props.layout,
...
function RenderArea(_ref8) {
	...
	var prevPoints = previousPointsRef.current;
	var prevBaseLine = previousBaselineRef.current;
	if (isAnimationActive && points && points.length && (prevPoints !== points || prevBaseLine !== baseLine)) return /* @__PURE__ */ import_react.createElement(AreaWithAnimation, {
		needClip,
		clipPathId,
		props,
		previousPointsRef,
...
var AreaWithState = class extends import_react.PureComponent {
	constructor() {
		super(...arguments);
		_defineProperty$12(this, "id", uniqueId("recharts-area-"));
	}
	render() {
		var _filterProps;
...
function AreaImpl(props) {
	var _useAppSelector;
	var _resolveDefaultProps = resolveDefaultProps(props, defaultAreaProps), { activeDot, animationBegin, animationDuration, animationEasing, connectNulls, dot, fill, fillOpacity, hide, isAnimationActive, legendType, stroke, xAxisId, yAxisId } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$11(_resolveDefaultProps, _excluded2$3);
	var layout = useChartLayout();
	var chartName = useChartName();
	var { needClip } = useNeedsClip(xAxisId, yAxisId);
	var isPanorama = useIsPanorama();
	var areaSettings = (0, import_react.useMemo)(() => ({
	...
	var { points, isRange, baseLine } = (_useAppSelector = useAppSelector((state) => selectArea(state, xAxisId, yAxisId, isPanorama, areaSettings))) !== null && _useAppSelector !== void 0 ? _useAppSelector : {};
	var { height, width, left, top } = useOffset();
	if (layout !== "horizontal" && layout !== "vertical") return null;
	if (chartName !== "AreaChart" && chartName !== "ComposedChart") return null;
	return /* @__PURE__ */ import_react.createElement(AreaWithState, _extends$12({}, everythingElse, {
		activeDot,
		animationBegin,
		animationDuration,
		animationEasing,
...
var Area = class extends import_react.PureComponent {
	render() {
		return /* @__PURE__ */ import_react.createElement(CartesianGraphicalItemContext, {
			type: "area",
			data: this.props.data,
			...
			hide: this.props.hide,
			barSize: void 0
		}, /* @__PURE__ */ import_react.createElement(SetLegendPayload, { legendPayload: computeLegendPayloadFromAreaData(this.props) }), /* @__PURE__ */ import_react.createElement(SetTooltipEntrySettings, {
			fn: getTooltipEntrySettings$5,
			args: this.props
		}), /* @__PURE__ */ import_react.createElement(AreaImpl, this.props));
	}
};
_defineProperty$12(Area, "displayName", "Area");
_defineProperty$12(Area, "defaultProps", defaultAreaProps);
//#endregion
...
var cartesianAxisSlice = createSlice({
	...
	reducers: {
		...
		updateYAxisWidth(state, action) {
			...
			if (state.yAxis[id]) state.yAxis[id] = _objectSpread$8(_objectSpread$8({}, state.yAxis[id]), {}, { width });
		}
	}
});
...
_defineProperty$10(ZAxis, "displayName", "ZAxis");
_defineProperty$10(ZAxis, "defaultProps", {
	zAxisId: 0,
...
function ScatterSymbol(_ref) {
	var { option, isActive } = _ref, props = _objectWithoutProperties$10(_ref, _excluded$10);
	if (typeof option === "string") return /* @__PURE__ */ import_react.createElement(Shape, _extends$11({
		option: /* @__PURE__ */ import_react.createElement(Symbols, _extends$11({ type: option }, props)),
		isActive,
		shapeType: "symbols"
	}, props));
...
var selectScatterPoints = createSelector([
	...
	selectYAxisTicks,
	selectZAxis,
	createSelector([selectUnfilteredCartesianItems, pickScatterSettings], (graphicalItems, scatterSettingsFromProps) => {
		if (graphicalItems.some((cgis) => cgis.type === "scatter" && scatterSettingsFromProps.dataKey === cgis.dataKey && scatterSettingsFromProps.data === cgis.data)) return scatterSettingsFromProps;
	}),
	pickCells
...
function ScatterLine(_ref) {
	...
	var lineProps = _objectSpread$7(_objectSpread$7(_objectSpread$7({}, scatterProps), {}, {
		fill: "none",
	...
	else lineItem = /* @__PURE__ */ import_react.createElement(Curve, _extends$10({}, lineProps, { type: lineJointType }));
	return /* @__PURE__ */ import_react.createElement(Layer, {
...
function ScatterSymbols(props) {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(ScatterLine, {
		...
		var symbolProps = _objectSpread$7(_objectSpread$7(_objectSpread$7({ key: "symbol-".concat(i) }, baseProps), entry), {}, {
			[DATA_ITEM_INDEX_ATTRIBUTE_NAME]: i,
			[DATA_ITEM_DATAKEY_ATTRIBUTE_NAME]: String(dataKey)
		});
		return /* @__PURE__ */ import_react.createElement(Layer, _extends$10({ className: "recharts-scatter-symbol" }, adaptEventsOfChild(restOfAllOtherProps, entry, i), {
			onMouseEnter: onMouseEnterFromContext(entry, i),
			onMouseLeave: onMouseLeaveFromContext(entry, i),
			onClick: onClickFromContext(entry, i),
			key: "symbol-".concat(entry === null || entry === void 0 ? void 0 : entry.cx, "-").concat(entry === null || entry === void 0 ? void 0 : entry.cy, "-").concat(entry === null || entry === void 0 ? void 0 : entry.size, "-").concat(i)
		}), /* @__PURE__ */ import_react.createElement(ScatterSymbol, _extends$10({
			option,
			isActive
		}, symbolProps)));
...
function SymbolsWithAnimation(_ref2) {
	...
	return /* @__PURE__ */ import_react.createElement(Animate, {
		...
		var stepData = t === 1 ? points : points.map((entry, index) => {
			...
			return _objectSpread$7(_objectSpread$7({}, entry), {}, { size: interpolator(t) });
		});
		if (t > 0) previousPointsRef.current = stepData;
...
function RenderSymbols(props) {
	...
	var previousPointsRef = (0, import_react.useRef)(null);
	var prevPoints = previousPointsRef.current;
	if (isAnimationActive && points && points.length && (!prevPoints || prevPoints !== points)) return /* @__PURE__ */ import_react.createElement(SymbolsWithAnimation, {
		props,
		previousPointsRef
	});
	return /* @__PURE__ */ import_react.createElement(ScatterSymbols, {
		points,
		allOtherScatterProps: props,
		showLabels: true
	});
...
function ScatterWithId(props) {
	var idRef = (0, import_react.useRef)(uniqueId("recharts-scatter-"));
	...
	return /* @__PURE__ */ import_react.createElement(Layer, {
		...
		errorBarOffset: 0
	}, children), /* @__PURE__ */ import_react.createElement(Layer, { key: "recharts-scatter-symbols" }, /* @__PURE__ */ import_react.createElement(RenderSymbols, props)));
}
...
function ScatterImpl(props) {
	var _resolveDefaultProps = resolveDefaultProps(props, defaultScatterProps), { animationBegin, animationDuration, animationEasing, hide, isAnimationActive, legendType, lineJointType, lineType, shape, xAxisId, yAxisId, zAxisId } = _resolveDefaultProps, everythingElse = _objectWithoutProperties$9(_resolveDefaultProps, _excluded2$2);
	var { needClip } = useNeedsClip(xAxisId, yAxisId);
	var cells = (0, import_react.useMemo)(() => findAllByType(props.children, Cell), [props.children]);
	var scatterSettings = (0, import_react.useMemo)(() => ({
		name: props.name,
		tooltipType: props.tooltipType,
		data: props.data,
		dataKey: props.dataKey
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement(SetTooltipEntrySettings, {
		...
		args: _objectSpread$7(_objectSpread$7({}, props), {}, { points })
	}), /* @__PURE__ */ import_react.createElement(ScatterWithId, _extends$10({}, everythingElse, {
		xAxisId,
		yAxisId,
		zAxisId,
		lineType,
...
var Scatter = class extends import_react.Component {
	render() {
		return /* @__PURE__ */ import_react.createElement(CartesianGraphicalItemContext, {
			type: "scatter",
			data: this.props.data,
			...
			hide: this.props.hide,
			barSize: void 0
		}, /* @__PURE__ */ import_react.createElement(SetLegendPayload, { legendPayload: computeLegendPayloadFromScatterProps(this.props) }), /* @__PURE__ */ import_react.createElement(ScatterImpl, this.props));
	}
};
_defineProperty$9(Scatter, "displayName", "Scatter");
_defineProperty$9(Scatter, "defaultProps", defaultScatterProps);
//#endregion
...
var XAxisImpl = (props) => {
	...
	var { dangerouslySetInnerHTML, ticks } = props, allOtherProps = _objectWithoutProperties$8(props, _excluded$8);
	return /* @__PURE__ */ import_react.createElement(CartesianAxis, _extends$9({}, allOtherProps, {
		scale,
		x: position.x,
		y: position.y,
...
var XAxis = class extends import_react.Component {
	render() {
		return /* @__PURE__ */ import_react.createElement(XAxisSettingsDispatcher, this.props);
	}
};
_defineProperty$8(XAxis, "displayName", "XAxis");
_defineProperty$8(XAxis, "defaultProps", {
...
var _excluded$7 = ["dangerouslySetInnerHTML", "ticks"];
...
var YAxisImpl = (props) => {
	...
	(0, import_react.useLayoutEffect)(() => {
		...
		if (width !== "auto" || !axisSize || isLabelContentAFunction(label) || /* @__PURE__ */ (0, import_react.isValidElement)(label)) return;
	...
	if (axisSize == null || position == null) return null;
	var { dangerouslySetInnerHTML, ticks } = props, allOtherProps = _objectWithoutProperties$7(props, _excluded$7);
	return /* @__PURE__ */ import_react.createElement(CartesianAxis, _extends$8({}, allOtherProps, {
...
var YAxis = class extends import_react.Component {
	render() {
		return /* @__PURE__ */ import_react.createElement(YAxisSettingsDispatcher, this.props);
	}
};
_defineProperty$7(YAxis, "displayName", "YAxis");
_defineProperty$7(YAxis, "defaultProps", YAxisDefaultProps);
//#endregion
...
var RechartsWrapper = /* @__PURE__ */ (0, import_react.forwardRef)((_ref, ref) => {
...
var CategoricalChart = /* @__PURE__ */ (0, import_react.forwardRef)((props, ref) => {
	...
	var attrs = filterProps(_objectWithoutProperties$5(props, _excluded$5), false);
...
var squarify = (node, aspectRatio) => {
	...
	if (children && children.length) {
		...
		return _objectSpread$5(_objectSpread$5({}, node), {}, { children: scaleChildren.map((c) => squarify(c, aspectRatio)) });
	}
	return node;
};
var defaultState = {
...
var TreemapWithState = class extends import_react.PureComponent {
	...
	handleNestIndex(node, i) {
		var { nestIndex } = this.state;
		var { width, height, dataKey, nameKey, aspectRatio } = this.props;
		var formatRoot = squarify(computeNode({
			depth: 0,
			node: _objectSpread$5(_objectSpread$5({}, node), {}, {
				x: 0,
				y: 0,
	...
	renderItem(content, nodeProps, isLeaf) {
		...
		return /* @__PURE__ */ import_react.createElement(Animate, {
			...
			return /* @__PURE__ */ import_react.createElement(Animate, {
				...
				isActive: isAnimationActive,
				duration: animationDuration
			}, /* @__PURE__ */ import_react.createElement(Layer, event, depth > 2 && !isAnimationFinished ? null : /* @__PURE__ */ import_react.createElement(ContentItemWithEvents, {
				content,
				dataKey,
				nodeProps: _objectSpread$5(_objectSpread$5({}, nodeProps), {}, {
					isAnimationActive,
	...
	renderNode(root, node) {
		...
		var nodeProps = _objectSpread$5(_objectSpread$5(_objectSpread$5({}, filterProps(this.props, false)), node), {}, { root });
	...
	renderNestIndex() {
		...
		return /* @__PURE__ */ import_react.createElement("div", {
			...
			var name = (0, import_get.default)(item, nameKey, "root");
			var content = null;
	...
	render() {
		...
		var attrs = filterProps(_objectWithoutProperties$2(_this$props, _excluded$2), false);
...
var import_sumBy = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var computeData = (_ref2) => {
	...
	for (var i = 1; i <= iterations; i++) {
		relaxRightToLeft(tree, depthTree, newLinks, alpha *= .99);
		resolveCollisions(depthTree, height, nodePadding, sort);
	...
	static getDerivedStateFromProps(nextProps, prevState) {
		...
		if (data !== prevState.prevData || width !== prevState.prevWidth || height !== prevState.prevHeight || !shallowEqual(margin, prevState.prevMargin) || iterations !== prevState.prevIterations || nodeWidth !== prevState.prevNodeWidth || nodePadding !== prevState.prevNodePadding || sort !== prevState.sort) {
			var { links, nodes } = computeData({
				data,
				width: width - (margin && margin.left || 0) - (margin && margin.right || 0),
				height: height - (margin && margin.top || 0) - (margin && margin.bottom || 0),
				iterations,
				nodeWidth,
				nodePadding,
				sort
			});
			var top = (0, import_get.default)(margin, "top") || 0;
			var left = (0, import_get.default)(margin, "left") || 0;
...
function getTooltipEntrySettings$1(_ref) {
...
function useAnimationId(reference) {
	var idRef = (0, import_react.useRef)(latestId);
	var ref = (0, import_react.useRef)(reference);
	...
	return /* @__PURE__ */ import_react.createElement(Animate, {
		...
		var stepData = t === 1 ? trapezoids : trapezoids.map((entry, index) => {
			...
			if (prev) {
				var _interpolatorX = interpolateNumber$1(prev.x, entry.x);
				var _interpolatorY = interpolateNumber$1(prev.y, entry.y);
				var _interpolatorUpperWidth = interpolateNumber$1(prev.upperWidth, entry.upperWidth);
				var _interpolatorLowerWidth = interpolateNumber$1(prev.lowerWidth, entry.lowerWidth);
				var _interpolatorHeight = interpolateNumber$1(prev.height, entry.height);
			...
			var interpolatorX = interpolateNumber$1(entry.x + entry.upperWidth / 2, entry.x);
			var interpolatorY = interpolateNumber$1(entry.y + entry.height / 2, entry.y);
			var interpolatorUpperWidth = interpolateNumber$1(0, entry.upperWidth);
			var interpolatorLowerWidth = interpolateNumber$1(0, entry.lowerWidth);
			var interpolatorHeight = interpolateNumber$1(0, entry.height);
			return _objectSpread(_objectSpread({}, entry), {}, {
				x: interpolatorX(t),
				y: interpolatorY(t),
...
function RenderTrapezoids(props) {
	...
	var previousTrapezoidsRef = (0, import_react.useRef)(null);
	var prevTrapezoids = previousTrapezoidsRef.current;
	if (isAnimationActive && trapezoids && trapezoids.length && (!prevTrapezoids || prevTrapezoids !== trapezoids)) return /* @__PURE__ */ import_react.createElement(TrapezoidsWithAnimation, {
		props,
		previousTrapezoidsRef
	});
	return /* @__PURE__ */ import_react.createElement(FunnelTrapezoids, {
		trapezoids,
		allOtherFunnelProps: props,
		showLabels: true
	});
...
function FunnelImpl(props) {
	...
	}), hide ? null : /* @__PURE__ */ import_react.createElement(FunnelWithState, _extends({}, everythingElse, {
		stroke,
		fill,
		nameKey,
		lastShapeType,
