...
//#region node_modules/ua-parser-js/dist/ua-parser.min.js
var require_ua_parser_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/react-device-detect/dist/lib.js
var require_lib = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var checkDeviceType = function checkDeviceType(type) {
		switch (type) {
			case DeviceTypes.Mobile: return { isMobile: true };
			case DeviceTypes.Tablet: return { isTablet: true };
			case DeviceTypes.SmartTv: return { isSmartTV: true };
			case DeviceTypes.Console: return { isConsole: true };
			case DeviceTypes.Wearable: return { isWearable: true };
			case DeviceTypes.Browser: return { isBrowser: true };
			case DeviceTypes.Embedded: return { isEmbedded: true };
			default: return InitialDeviceTypes;
		}
	};
	...
	var isMobileType = function isMobileType(_ref) {
		return _ref.type === DeviceTypes.Mobile;
	};
	var isTabletType = function isTabletType(_ref2) {
		return _ref2.type === DeviceTypes.Tablet;
	};
	...
	var isSmartTVType = function isSmartTVType(_ref4) {
		return _ref4.type === DeviceTypes.SmartTv;
	};
	var isBrowserType = function isBrowserType(_ref5) {
		return _ref5.type === DeviceTypes.Browser;
	};
	var isWearableType = function isWearableType(_ref6) {
		return _ref6.type === DeviceTypes.Wearable;
	};
	var isConsoleType = function isConsoleType(_ref7) {
		return _ref7.type === DeviceTypes.Console;
	};
	var isEmbeddedType = function isEmbeddedType(_ref8) {
		return _ref8.type === DeviceTypes.Embedded;
	};
	...
	var isAndroidType = function isAndroidType(_ref12) {
		return _ref12.name === OsTypes.Android;
	};
	var isWindowsType = function isWindowsType(_ref13) {
		return _ref13.name === OsTypes.Windows;
	};
	var isMacOsType = function isMacOsType(_ref14) {
		return _ref14.name === OsTypes.MAC_OS;
	};
	var isWinPhoneType = function isWinPhoneType(_ref15) {
		return _ref15.name === OsTypes.WindowsPhone;
	};
	var isIOSType = function isIOSType(_ref16) {
		return _ref16.name === OsTypes.IOS;
	};
	...
	var isChromeType = function isChromeType(_ref19) {
		return _ref19.name === BrowserTypes.Chrome;
	};
	var isFirefoxType = function isFirefoxType(_ref20) {
		return _ref20.name === BrowserTypes.Firefox;
	};
	var isChromiumType = function isChromiumType(_ref21) {
		return _ref21.name === BrowserTypes.Chromium;
	};
	var isEdgeType = function isEdgeType(_ref22) {
		return _ref22.name === BrowserTypes.Edge;
	};
	var isYandexType = function isYandexType(_ref23) {
		return _ref23.name === BrowserTypes.Yandex;
	};
	...
	var isMobileSafariType = function isMobileSafariType(_ref25) {
		return _ref25.name === BrowserTypes.MobileSafari;
	};
	var isOperaType = function isOperaType(_ref26) {
		return _ref26.name === BrowserTypes.Opera;
	};
	...
	var isMIUIType = function isMIUIType(_ref28) {
		return _ref28.name === BrowserTypes.MIUI;
	};
	var isSamsungBrowserType = function isSamsungBrowserType(_ref29) {
		return _ref29.name === BrowserTypes.SamsungBrowser;
	};
	...
	var CustomView = function CustomView(_ref12) {
		...
		_ref12.style;
		var condition = _ref12.condition, props = _objectWithoutProperties(_ref12, [
			"renderWithFragment",
			"children",
			"viewClassName",
			"style",
	...
	function useMobileOrientation() {
		var _useState2 = _slicedToArray(React.useState(function() {
			var orientation = window.innerWidth > window.innerHeight ? 90 : 0;
			return {
				isPortrait: orientation === 0,
				isLandscape: orientation === 90,
		...
		}), 2), state = _useState2[0], setState = _useState2[1];
	...
	function useDeviceData(userAgent) {
		return parseUserAgent(userAgent ? userAgent : window.navigator.userAgent);
	}
	function useDeviceSelectors(userAgent) {
		var deviceData = useDeviceData(userAgent ? userAgent : window.navigator.userAgent);
		return [buildSelectorsObject(deviceData), deviceData];
	}
