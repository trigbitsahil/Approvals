...
import { t as require_lib$17 } from "./lib-DEJ4yF23.js";
//#region node_modules/@react-pdf-viewer/attachment/lib/cjs/attachment.js
var require_attachment = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	...
	var AttachmentList = function(_a) {
		...
		var isRtl = React__namespace.useContext(core.ThemeContext).direction === core.TextDirection.RightToLeft;
		...
		var moveToItem = function(getItemIndex) {
			...
			var targetEle = attachmentItems[Math.min(attachmentItems.length - 1, Math.max(0, getItemIndex(attachmentItems, activeEle)))];
	...
	var AttachmentLoader = function(_a) {
		...
		React__namespace.useEffect(function() {
			doc.getAttachments().then(function(response) {
				setAttachments({
					files: response ? Object.keys(response).map(function(file) {
						return {
	...
	var AttachmentListWithStore = function(_a) {
		...
		return currentDoc ? React__namespace.createElement(AttachmentLoader, { doc: currentDoc }) : React__namespace.createElement("div", { className: "rpv-attachment__loader" }, React__namespace.createElement(core.Spinner, null));
	};
...
//#endregion
//#region node_modules/@react-pdf-viewer/attachment/lib/index.js
/**
...
//#endregion
//#region node_modules/@react-pdf-viewer/bookmark/lib/cjs/bookmark.js
var require_bookmark = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	***************************************************************************** */
	...
	var DownArrowIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M6.427,8.245A.5.5,0,0,1,6.862,7.5H17.138a.5.5,0,0,1,.435.749l-5.139,9a.5.5,0,0,1-.868,0Z" }));
	};
	var RightArrowIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M9.248,17.572a.5.5,0,0,1-.748-.434V6.862a.5.5,0,0,1,.748-.434l8.992,5.138a.5.5,0,0,1,0,.868Z" }));
	};
	var shouldBeCollapsed = function(bookmark) {
		var count = bookmark.count, items = bookmark.items;
		if (count >= 0) return false;
		var numSubItems = items.length;
		if (numSubItems === 0) return false;
	...
	var BookmarkItem = function(_a) {
		...
		var jumpToDest = function() {
			...
			core.getDestination(doc, dest).then(function(target) {
				if (jumpToDestination) jumpToDestination(__assign({ label: bookmark.title }, target));
			});
		};
		var clickBookmark = function() {
			if (hasSubItems && bookmark.dest) jumpToDest();
		};
		...
		var defaultRenderItem = function(onClickItem, children) {
			return React__namespace.createElement("div", {
				...
				style: { paddingLeft: "".concat(depth * 1.25, "rem") },
				onClick: onClickItem
			}, children);
		};
		var defaultRenderToggle = function(expandIcon, collapseIcon) {
			...
			}, expanded ? expandIcon : collapseIcon) : React__namespace.createElement("span", { className: "rpv-bookmark__toggle" });
		};
	...
	var BookmarkListRoot = function(_a) {
		...
		var handleKeyDown = function(e) {
			var container = containerRef.current;
			if (!container || !(e.target instanceof HTMLElement) || !container.contains(e.target)) return;
			switch (e.key) {
				case "ArrowDown":
					e.preventDefault();
		...
		var clickBookmark = function() {
			var titleEle = document.activeElement.closest(".rpv-bookmark__item").querySelector(".rpv-bookmark__title");
			if (titleEle) titleEle.click();
		};
		var moveToItem = function(getItemIndex) {
			var container = containerRef.current;
			...
			var activeEle = document.activeElement;
			var targetEle = bookmarkElements[Math.min(bookmarkElements.length - 1, Math.max(0, getItemIndex(bookmarkElements, activeEle)))];
		...
		var toggle = function(toggle) {
			var container = containerRef.current;
			if ([].slice.call(container.getElementsByClassName("rpv-bookmark__item")).length === 0) return;
		...
		return React__namespace.createElement("div", { ref: containerRef }, React__namespace.createElement(BookmarkList, {
			bookmarks,
			depth: 0,
			doc,
			isBookmarkExpanded,
	...
	var BookmarkLoader = function(_a) {
		...
		return !bookmarks.isLoaded ? React__namespace.createElement("div", { className: "rpv-bookmark__loader" }, React__namespace.createElement(core.Spinner, null)) : bookmarks.items.length === 0 ? React__namespace.createElement("div", {
	...
	var BookmarkListWithStore = function(_a) {
		...
		return currentDoc ? React__namespace.createElement(BookmarkLoader, {
			...
			renderBookmarkItem,
			store
		}) : React__namespace.createElement("div", { className: "rpv-bookmark__loader" }, React__namespace.createElement(core.Spinner, null));
	};
	var bookmarkPlugin = function() {
		var store = React__namespace.useMemo(function() {
			return core.createStore({ bookmarkExpandedMap: /* @__PURE__ */ new Map() });
		}, []);
...
//#endregion
//#region node_modules/@react-pdf-viewer/bookmark/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/thumbnail/lib/cjs/thumbnail.js
var require_thumbnail = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	***************************************************************************** */
	...
	var CoverInner = function(_a) {
		...
		var handlePagesRotationChanged = function(rotations) {
			setPageRotation(rotations.has(normalizePage) ? rotations.get(normalizePage) : 0);
		};
		...
		var containerRef = core.useIntersectionObserver({ onVisibilityChanged: handleVisibilityChanged });
		React__namespace.useEffect(function() {
			if (!isVisible) return;
			...
			core.getPage(doc, normalizePage).then(function(page) {
				...
				var rotationValue = (viewport.rotation + rotation + pageRotation) % 360;
		...
		React__namespace.useEffect(function() {
			return function() {
				var _a;
				(_a = renderTask.current) === null || _a === void 0 || _a.cancel();
			};
		}, []);
		return React__namespace.createElement("div", {
			ref: containerRef,
	...
	var Cover = function(_a) {
		...
		return React__namespace.createElement("div", { className: "rpv-thumbnail__cover" }, currentDoc ? React__namespace.createElement(CoverInner, {
			...
			store,
			width
		}) : React__namespace.createElement("div", { className: "rpv-thumbnail__cover-loader" }, renderSpinner ? renderSpinner() : React__namespace.createElement(core.Spinner, null)));
	};
	var defaultSpinner = function() {
		return React__namespace.createElement(core.Spinner, null);
	};
	var SpinnerContext = React__namespace.createContext({ renderSpinner: defaultSpinner });
	...
	var scrollToBeVisibleVertically = function(ele, container) {
		...
		if (top + eleHeight <= containerHeight) return;
	...
	var scrollToBeVisibleHorizontally = function(ele, container) {
		...
		if (left + eleWidth <= containerWidth) return;
	...
	var ThumbnailContainer = function(_a) {
		...
		React__namespace.useEffect(function() {
			if (shouldRender) core.getPage(doc, pageIndex).then(function(pdfPage) {
		...
		var containerRef = core.useIntersectionObserver({ onVisibilityChanged: function(visibility) {
	...
	var ThumbnailList = function(_a) {
		...
		var chunks = React__namespace.useMemo(function() {
			switch (viewMode) {
				case core.ViewMode.DualPage: return core.chunk(pageIndexes, 2);
				case core.ViewMode.DualPageWithCover: return [[pageIndexes[0]]].concat(core.chunk(pageIndexes.slice(1), 2));
				case core.ViewMode.SinglePage:
				default: return core.chunk(pageIndexes, 1);
			}
		}, [docId, viewMode]);
		var handleKeyDown = function(e) {
			switch (e.key) {
		...
		var activateNextItem = function() {
			...
			if (nextItem < items.length) {
				if (currentFocused >= 0) items[currentFocused].setAttribute("tabindex", "-1");
		...
		var jumpToFocusedPage = function() {
			if (currentFocused >= 0 && currentFocused < numPages) onJumpToPage(currentFocused);
		};
		core.useIsomorphicLayoutEffect(function() {
			var container = containerRef.current;
			if (!container) return;
		...
		React__namespace.useEffect(function() {
			...
			if (thumbnails.length === 0 || currentFocused < 0 || currentFocused > thumbnails.length) return;
		...
		core.useIsomorphicLayoutEffect(function() {
			var container = containerRef.current;
			var thumbnails = thumbnailsRef.current;
			if (!container || thumbnails.length === 0 || currentPage < 0 || currentPage > thumbnails.length) return;
			var thumbnailContainer = thumbnails[currentPage].closest(".rpv-thumbnail__items");
			if (thumbnailContainer) thumbnailDirection === exports.ThumbnailDirection.Vertical ? scrollToBeVisibleVertically(thumbnailContainer, container) : scrollToBeVisibleHorizontally(thumbnailContainer, container);
		...
		var renderNextThumbnail = React__namespace.useCallback(function() {
			if (hasRenderingThumbnailRef.current) return;
		...
		var renderPageThumbnail = function(pageIndex) {
			...
			}) : React__namespace.createElement("div", { key }, React__namespace.createElement("div", {
				className: core.classNames({
	...
	var ThumbnailListWithStore = function(_a) {
		...
		var jump = function(pageIndex) {
			...
			if (jumpToPage) jumpToPage(pageIndex);
		};
	...
	var thumbnailPlugin = function(pluginProps) {
		...
		return {
			...
			Thumbnails: React__namespace.useCallback(function(props) {
				return React__namespace.createElement(SpinnerContext.Provider, { value: { renderSpinner: (pluginProps === null || pluginProps === void 0 ? void 0 : pluginProps.renderSpinner) || defaultSpinner } }, React__namespace.createElement(ThumbnailListWithStore, {
...
//#endregion
//#region node_modules/@react-pdf-viewer/thumbnail/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/selection-mode/lib/cjs/selection-mode.js
var require_selection_mode = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	var HandToolIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M11.5,5.5v-2C11.5,2.672,12.172,2,13,2s1.5,0.672,1.5,1.5v2 M14.5,11.5v-6C14.5,4.672,15.172,4,16,4\n            c0.828,0,1.5,0.672,1.5,1.5v3 M17.5,13V8.5C17.5,7.672,18.172,7,19,7s1.5,0.672,1.5,1.5v10c0,2.761-2.239,5-5,5h-3.335\n            c-1.712-0.001-3.305-0.876-4.223-2.321C6.22,18.467,4.083,14,4.083,14c-0.378-0.545-0.242-1.292,0.303-1.67\n            c0.446-0.309,1.044-0.281,1.458,0.07L8.5,15.5v-10C8.5,4.672,9.172,4,10,4s1.5,0.672,1.5,1.5v6" }));
	};
	/******************************************************************************
	Copyright (c) Microsoft Corporation.
	...
	***************************************************************************** */
	...
	var TextSelectionIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M13.675,11.671l2.941-2.941c0.195-0.196,0.195-0.512-0.001-0.707C16.563,7.971,16.5,7.931,16.43,7.906\n            L4.168,3.527C3.908,3.434,3.622,3.57,3.529,3.83c-0.039,0.109-0.039,0.228,0,0.336l4.379,12.262\n            c0.093,0.26,0.379,0.396,0.639,0.303c0.07-0.025,0.133-0.065,0.185-0.117l2.943-2.943l6.146,6.146c0.195,0.195,0.512,0.195,0.707,0\n            l1.293-1.293c0.195-0.195,0.195-0.512,0-0.707L13.675,11.671z" }));
	};
	...
	var SwitchSelectionModeButton = function(_a) {
		...
		switch (mode) {
			case exports.SelectionMode.Hand:
				...
				break;
			case exports.SelectionMode.Text:
			default: testId = "selection-mode__text-button";
		}
	...
	var SwitchSelectionModeMenuItem = function(_a) {
		...
		switch (mode) {
			case exports.SelectionMode.Hand:
				...
				break;
			case exports.SelectionMode.Text:
			default: testId = "selection-mode__text-menu";
		}
		return React__namespace.createElement(SwitchSelectionModeDecorator, {
			mode,
			onClick
	...
	var Tracker = function(_a) {
		...
		var onMouseDownHandler = function(e) {
			var ele = pagesRef.current;
			if (!ele || selectionMode === exports.SelectionMode.Text) return;
	...
	var selectionModePlugin = function(props) {
		...
		var SwitchSelectionModeDecorator = function(props) {
			return React__namespace.createElement(SwitchSelectionMode, __assign({}, props, { store }));
		};
		var SwitchSelectionModeButtonDecorator = function(props) {
			return React__namespace.createElement(SwitchSelectionModeDecorator, { mode: props.mode }, function(p) {
				return React__namespace.createElement(SwitchSelectionModeButton, {
		...
		var renderViewer = function(props) {
			...
			if (currentSlot.subSlot && currentSlot.subSlot.children) currentSlot.subSlot.children = React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement(Tracker, { store }), currentSlot.subSlot.children);
			return currentSlot;
		};
		return {
			install: function(pluginFunctions) {
...
//#endregion
//#region node_modules/@react-pdf-viewer/selection-mode/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/full-screen/lib/cjs/full-screen.js
var require_full_screen = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	var ExitFullScreenIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M11.5 23.499L11.5 14.499" }), React__namespace.createElement("path", { d: "M7.5 18.499L11.5 14.499 15.5 18.499" }), React__namespace.createElement("path", { d: "M11.5 1.499L11.5 10.499" }), React__namespace.createElement("path", { d: "M7.5 6.499L11.5 10.499 15.5 6.499" }), React__namespace.createElement("path", { d: "M20.5 12.499L1.5 12.499" }));
	};
	var FullScreenIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M0.5 12L23.5 12" }), React__namespace.createElement("path", { d: "M11.5 1L11.5 23" }), React__namespace.createElement("path", { d: "M8.5 4L11.5 1 14.5 4" }), React__namespace.createElement("path", { d: "M20.5 9L23.5 12 20.5 15" }), React__namespace.createElement("path", { d: "M3.5 15L0.5 12 3.5 9" }), React__namespace.createElement("path", { d: "M14.5 20L11.5 23 8.5 20" }));
	};
	/******************************************************************************
	Copyright (c) Microsoft Corporation.
	...
	***************************************************************************** */
	...
	var EnterFullScreen = function(_a) {
		...
		var defaultChildren = function(props) {
			return isFullScreen ? React__namespace.createElement(ExitFullScreenButtonWithTooltip, { onClick: props.onClick }) : React__namespace.createElement(EnterFullScreenButton, {
				enableShortcuts,
				onClick: props.onClick
			});
		};
		return (children || defaultChildren)({ onClick: isFullScreen ? exitFullScreen : enterFullScreen });
	};
	...
	var ExitFullScreen = function(_a) {
		...
		return isFullScreen && (children || defaultChildren)({ onClick: isFullScreen ? exitFullScreen : enterFullScreen });
	};
	var FullScreenModeTracker = function(_a) {
		...
		return (fullScreenMode === core.FullScreenMode.Entering || fullScreenMode === core.FullScreenMode.Entered) && React__namespace.createElement("div", { className: "rpv-full-screen__overlay" }, React__namespace.createElement(core.Spinner, null));
	};
	var ShortcutHandler = function(_a) {
		...
		var keydownHandler = function(e) {
			...
			if (!(core.isMac() ? e.metaKey && e.ctrlKey && e.key === "f" : e.key === "F11")) return;
			var containerEle = containerRef.current;
			if (!containerEle || !document.activeElement || !containerEle.contains(document.activeElement)) return;
			e.preventDefault();
			enterFullScreen();
		};
		React__namespace.useEffect(function() {
	...
	var fullScreenPlugin = function(props) {
		...
		var renderViewer = function(props) {
			var currentSlot = props.slot;
			if (currentSlot.subSlot) currentSlot.subSlot.children = React__namespace.createElement(React__namespace.Fragment, null, fullScreenPluginProps.enableShortcuts && React__namespace.createElement(ShortcutHandler, {
...
//#endregion
//#region node_modules/@react-pdf-viewer/full-screen/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/get-file/lib/cjs/get-file.js
var require_get_file = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	var DownloadIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M5.5,11.5c-.275,0-.341.159-.146.354l6.292,6.293a.5.5,0,0,0,.709,0l6.311-6.275c.2-.193.13-.353-.145-.355L15.5,11.5V1.5a1,1,0,0,0-1-1h-5a1,1,0,0,0-1,1V11a.5.5,0,0,1-.5.5Z" }), React__namespace.createElement("path", { d: "M23.5,18.5v4a1,1,0,0,1-1,1H1.5a1,1,0,0,1-1-1v-4" }));
	};
	/******************************************************************************
	Copyright (c) Microsoft Corporation.
	...
	***************************************************************************** */
	...
	var Download = function(_a) {
		...
		var download = function() {
			if (currentDocument && currentFile) downloadFile(currentDocument, fileNameGenerator(currentFile));
		};
		var defaultChildren = function(props) {
			return React__namespace.createElement(DownloadButton, { onClick: props.onClick });
		};
		return (children || defaultChildren)({ onClick: download });
	};
...
//#endregion
//#region node_modules/@react-pdf-viewer/get-file/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/open/lib/cjs/open.js
var require_open = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	var OpenFileIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M18.5,7.5c.275,0,.341-.159.146-.354L12.354.854a.5.5,0,0,0-.708,0L5.354,7.147c-.2.195-.129.354.146.354h3v10a1,1,0,0,0,1,1h5a1,1,0,0,0,1-1V7.5Z" }), React__namespace.createElement("path", { d: "M23.5,18.5v4a1,1,0,0,1-1,1H1.5a1,1,0,0,1-1-1v-4" }));
	};
	/******************************************************************************
	Copyright (c) Microsoft Corporation.
	...
	***************************************************************************** */
	...
	var useTriggerOpen = function(store) {
		...
		var openFile = function() {
			...
			if (inputEle) {
				inputEle.click();
				if (store.get("triggerOpenFile")) store.update("triggerOpenFile", false);
			}
		};
	...
	var OpenButton = function(_a) {
		...
		return React__namespace.createElement(core.Tooltip, {
			...
			position: core.Position.BottomCenter,
			target: React__namespace.createElement("div", { className: "rpv-open__input-wrapper" }, React__namespace.createElement("input", {
				accept: ".pdf",
				ref: inputRef,
	...
	var Open = function(_a) {
		...
		return (children || defaultChildren)({ onClick: handleOpenFiles });
	};
	var OpenMenuItem = function(_a) {
		...
		return React__namespace.createElement(core.MenuItem, {
			...
			testId: "open__menu",
			onClick: openFile
		}, React__namespace.createElement("div", { className: "rpv-open__input-wrapper" }, React__namespace.createElement("input", {
			accept: ".pdf",
			ref: inputRef,
			className: "rpv-open__input",
			multiple: false,
	...
	var ShortcutHandler = function(_a) {
		...
		var keydownHandler = function(e) {
			if (e.shiftKey || e.altKey || e.key !== "o") return;
			if (!(core.isMac() ? e.metaKey : e.ctrlKey)) return;
			var containerEle = containerRef.current;
			if (!containerEle || !document.activeElement || !containerEle.contains(document.activeElement)) return;
			e.preventDefault();
	...
	var openPlugin = function(props) {
		...
		var OpenDecorator = function(props) {
			return React__namespace.createElement(Open, __assign({ enableShortcuts: openPluginProps.enableShortcuts }, props, { store }));
		};
		...
		var renderViewer = function(props) {
			var slot = props.slot;
			var updateSlot = { children: React__namespace.createElement(React__namespace.Fragment, null, openPluginProps.enableShortcuts && React__namespace.createElement(ShortcutHandler, {
				containerRef: props.containerRef,
				store
			}), slot.children) };
...
//#endregion
//#region node_modules/@react-pdf-viewer/open/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/page-navigation/lib/cjs/page-navigation.js
var require_page_navigation = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	var React__namespace = /* @__PURE__ */ _interopNamespaceDefault(React);
	var DownArrowIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M2.32,2.966h19.452c0.552,0.001,1,0.449,0.999,1.001c0,0.182-0.05,0.36-0.144,0.516L12.9,20.552\n            c-0.286,0.472-0.901,0.624-1.373,0.338c-0.138-0.084-0.254-0.2-0.338-0.338L1.465,4.483C1.179,4.01,1.331,3.396,1.804,3.11\n            C1.96,3.016,2.138,2.966,2.32,2.966z" }));
	};
	var NextIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M0.541,5.627L11.666,18.2c0.183,0.207,0.499,0.226,0.706,0.043c0.015-0.014,0.03-0.028,0.043-0.043\n            L23.541,5.627" }));
	};
	/******************************************************************************
	Copyright (c) Microsoft Corporation.
	...
	***************************************************************************** */
	...
	var CurrentPageInput = function(_a) {
		...
		return React__namespace.createElement("span", { className: "rpv-page-navigation__current-page-input" }, React__namespace.createElement(core.TextBox, {
			ariaLabel: label,
	...
	var UpArrowIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M21.783,21.034H2.332c-0.552,0-1-0.448-1-1c0-0.182,0.05-0.361,0.144-0.517L11.2,3.448\n            c0.286-0.472,0.901-0.624,1.373-0.338c0.138,0.084,0.254,0.2,0.338,0.338l9.726,16.069c0.286,0.473,0.134,1.087-0.339,1.373\n            C22.143,20.984,21.965,21.034,21.783,21.034z" }));
	};
	...
	var GoToLastPage = function(_a) {
		...
		var goToLastPage = function() {
			var jumpToPage = store.get("jumpToPage");
			if (jumpToPage) jumpToPage(numberOfPages - 1);
		};
		var defaultChildren = function(props) {
	...
	var PreviousIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M23.535,18.373L12.409,5.8c-0.183-0.207-0.499-0.226-0.706-0.043C11.688,5.77,11.674,5.785,11.66,5.8\n            L0.535,18.373" }));
	};
	var TOOLTIP_OFFSET = {
		left: 0,
		top: 8
	...
	var ShortcutHandler = function(_a) {
		...
		var handleKeydown = function(e) {
			...
			if (core.isMac() ? e.metaKey && !e.ctrlKey : e.altKey) switch (e.key) {
				case "ArrowLeft":
					e.preventDefault();
	...
	var pageNavigationPlugin = function(props) {
		...
		var CurrentPageLabelDecorator = function(props) {
			return React__namespace.createElement(CurrentPageLabel, __assign({}, props, { store }));
		};
		var GoToFirstPageDecorator = function(props) {
			return React__namespace.createElement(GoToFirstPage, __assign({}, props, { store }));
		};
		...
		var GoToLastPageDecorator = function(props) {
			return React__namespace.createElement(GoToLastPage, __assign({}, props, { store }));
		};
		...
		var GoToNextPageDecorator = function(props) {
			return React__namespace.createElement(GoToNextPage, __assign({}, props, { store }));
		};
		...
		var GoToPreviousPageDecorator = function(props) {
			return React__namespace.createElement(GoToPreviousPage, __assign({}, props, { store }));
		};
		...
		var NumberOfPagesDecorator = function(props) {
			return React__namespace.createElement(NumberOfPages, __assign({}, props, { store }));
		};
		var renderViewer = function(props) {
			var slot = props.slot;
			if (!pageNavigationPluginProps.enableShortcuts) return slot;
			var updateSlot = { children: React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement(ShortcutHandler, {
				containerRef: props.containerRef,
...
//#endregion
//#region node_modules/@react-pdf-viewer/page-navigation/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/print/lib/cjs/print.js
var require_print = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	...
	var getCustomPagesNumbers = function(customPages) {
		return function(doc) {
			...
			customPages.replace(/\s+/g, "").split(",").forEach(function(part) {
				...
				if (range.length === 1) results.push(range[0] - 1);
				else if (range.length === 2) results.push.apply(results, generateRange(range[0] - 1, range[1] - 1));
			});
	...
	var PrintIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M7.5,19.499h9 M7.5,16.499h9 M5.5,16.5h-3c-1.103-0.003-1.997-0.897-2-2v-6c0.003-1.103,0.897-1.997,2-2h19\n            c1.103,0.003,1.997,0.897,2,2v6c-0.003,1.103-0.897,1.997-2,2h-3\n            M5.5,4.5v-4h9.586c0.265,0,0.52,0.105,0.707,0.293l2.414,2.414\n            C18.395,3.394,18.5,3.649,18.5,3.914V4.5\n            M18.5,22.5c0,0.552-0.448,1-1,1h-11c-0.552,0-1-0.448-1-1v-9h13V22.5z\n            M3.5,8.499\n            c0.552,0,1,0.448,1,1s-0.448,1-1,1s-1-0.448-1-1S2.948,8.499,3.5,8.499z\n            M14.5,0.499v4h4" }));
	};
	/******************************************************************************
	Copyright (c) Microsoft Corporation.
	...
	***************************************************************************** */
	...
	var CheckPrintPermission = function(_a) {
		...
		React__namespace.useEffect(function() {
			doc.getPermissions().then(function(permissions) {
				permissions === null || permissions.includes(PERMISSION_PRINT) || permissions.includes(PERMISSION_PRINT_HIGHT_QUALITY) ? store.update("printStatus", PrintStatus.Preparing) : setIsAllowed(false);
			});
		}, []);
		return isAllowed ? React__namespace.createElement(React__namespace.Fragment, null) : React__namespace.createElement(core.Modal, {
			...
			content: function(toggle) {
				...
				return React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement("div", { className: "rpv-print__permission-body" }, l10n && l10n.print ? l10n.print.disallowPrint : "The document does not allow to print"), React__namespace.createElement("div", { className: "rpv-print__permission-footer" }, React__namespace.createElement(core.Button, { onClick: close }, l10n && l10n.print ? l10n.print.close : "Close")));
			},
			isOpened: true
		});
	};
	var PrintProgress = function(_a) {
		...
		return React__namespace.createElement("div", { className: "rpv-print__progress" }, React__namespace.createElement("div", { className: core.classNames({
			"rpv-print__progress-body": true,
			"rpv-print__progress-body--rtl": isRtl
		}) }, React__namespace.createElement("div", { className: "rpv-print__progress-message" }, l10n && l10n.print ? l10n.print.preparingDocument : "Preparing document ..."), React__namespace.createElement("div", { className: "rpv-print__progress-bar" }, React__namespace.createElement(core.ProgressBar, { progress })), React__namespace.createElement(core.Button, { onClick: onCancel }, l10n && l10n.print ? l10n.print.cancel : "Cancel")));
	};
	...
	var PageThumbnail = function(_a) {
		...
		React__namespace.useEffect(function() {
			...
			renderTask.current.promise.then(function() {
				if ("toBlob" in canvas && "createObjectURL" in URL) canvas.toBlob(function(blob) {
		...
		return src && React__namespace.createElement("div", { className: "rpv-print__page" }, React__namespace.createElement("img", {
	...
	var PrintZone = function(_a) {
		...
		React__namespace.useEffect(function() {
			...
			var handler = function() {
				if (printStatus === PrintStatus.Ready) {
					...
					if (zones) zones.forEach(function(zoneEle) {
		...
		}), React__namespace.createElement("style", { dangerouslySetInnerHTML: { __html: "@page { size: ".concat(pageWidth, "pt ").concat(pageHeight, "pt }") } })), container);
	};
	...
	var ShortcutHandler = function(_a) {
		var containerRef = _a.containerRef, store = _a.store;
		var keydownHandler = function(e) {
			if (e.shiftKey || e.altKey || e.key !== "p") return;
			if (!(core.isMac() ? e.metaKey : e.ctrlKey)) return;
			var containerEle = containerRef.current;
			if (!containerEle || !document.activeElement || !containerEle.contains(document.activeElement)) return;
			e.preventDefault();
	...
	var printPlugin = function(props) {
		...
		var store = React__namespace.useMemo(function() {
			return core.createStore({ printStatus: PrintStatus.Inactive });
		}, []);
		var print = function() {
			store.update("printStatus", PrintStatus.CheckingPermission);
		};
		var PrintDecorator = function(props) {
			return React__namespace.createElement(Print, __assign({ enableShortcuts: printPluginProps.enableShortcuts }, props, { store }));
		};
		...
		var renderViewer = function(renderViewerProps) {
			...
			var updateSlot = { children: React__namespace.createElement(React__namespace.Fragment, null, printPluginProps.enableShortcuts && React__namespace.createElement(ShortcutHandler, {
...
//#endregion
//#region node_modules/@react-pdf-viewer/print/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
* @copyright 2019-2023 Nguyen Huu Phuoc <me@phuoc.ng>
*/
var require_lib$8 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_print();
}));
//#endregion
//#region node_modules/@react-pdf-viewer/properties/lib/cjs/properties.js
var require_properties = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var InfoIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M12,1.001c6.075,0,11,4.925,11,11s-4.925,11-11,11s-11-4.925-11-11S5.925,1.001,12,1.001z\n            M14.5,17.005H13\n            c-0.552,0-1-0.448-1-1v-6.5c0-0.276-0.224-0.5-0.5-0.5H10\n            M11.745,6.504L11.745,6.504\n            M11.745,6.5c-0.138,0-0.25,0.112-0.25,0.25\n            S11.607,7,11.745,7s0.25-0.112,0.25-0.25S11.883,6.5,11.745,6.5" }));
	};
	/******************************************************************************
	Copyright (c) Microsoft Corporation.
	...
	***************************************************************************** */
	...
	var PropertiesLoader = function(_a) {
		...
		return data ? render(data) : React__namespace.createElement("div", { className: "rpv-properties__loader" }, React__namespace.createElement(core.Spinner, null));
	};
	var PropertyItem = function(_a) {
		...
		}) }, React__namespace.createElement("dt", { className: "rpv-properties__item-label" }, label, ":"), React__namespace.createElement("dd", { className: "rpv-properties__item-value" }, value || "-"));
	};
	var dateRegex = /* @__PURE__ */ new RegExp("^D:(\\d{4})(\\d{2})?(\\d{2})?(\\d{2})?(\\d{2})?(\\d{2})?([Z|+|-])?(\\d{2})?'?(\\d{2})?'?");
	...
	var PropertiesModal = function(_a) {
		...
		var renderData = function(data) {
			return React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement("div", { className: "rpv-properties__modal-section" }, React__namespace.createElement(PropertyItem, {
			...
			})), React__namespace.createElement(core.Separator, null), React__namespace.createElement("div", { className: "rpv-properties__modal-section" }, React__namespace.createElement(PropertyItem, {
		...
		return React__namespace.createElement("div", { className: "rpv-properties__modal" }, React__namespace.createElement(PropertiesLoader, {
			doc,
			render: renderData
		}), React__namespace.createElement("div", { className: "rpv-properties__modal-footer" }, React__namespace.createElement(core.Button, { onClick: onToggle }, l10n && l10n.properties ? l10n.properties.close : "Close")));
	};
	var TOOLTIP_OFFSET = {
		left: 0,
		top: 8
	...
	var propertiesPlugin = function() {
		var store = React__namespace.useMemo(function() {
			return core.createStore({ fileName: "" });
		}, []);
...
//#endregion
//#region node_modules/@react-pdf-viewer/properties/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/rotate/lib/cjs/rotate.js
var require_rotate = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	***************************************************************************** */
	...
	var RotatePage = function(_a) {
		...
		var onRotatePage = function(pageIndex, direction) {
			...
			if (rotatePage) rotatePage(pageIndex, direction);
		};
		return children({ onRotatePage });
	};
...
//#endregion
//#region node_modules/@react-pdf-viewer/rotate/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/scroll-mode/lib/cjs/scroll-mode.js
var require_scroll_mode = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	var DualPageCoverViewModeIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("rect", {
			x: "0.5",
			y: "0.497",
			width: "22",
			height: "22",
	...
	var HorizontalScrollingIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M6.5,21.5c0,0.552-0.448,1-1,1h-4c-0.552,0-1-0.448-1-1v-20c0-0.552,0.448-1,1-1h4c0.552,0,1,0.448,1,1V21.5z\n            M14.5,21.5c0,0.552-0.448,1-1,1h-4c-0.552,0-1-0.448-1-1v-20c0-0.552,0.448-1,1-1h4c0.552,0,1,0.448,1,1V21.5z\n            M22.5,21.5 c0,0.552-0.448,1-1,1h-4c-0.552,0-1-0.448-1-1v-20c0-0.552,0.448-1,1-1h4c0.552,0,1,0.448,1,1V21.5z" }));
	};
	...
	***************************************************************************** */
	...
	var switchScrollMode = function(store, scrollMode) {
		...
		if ((scrollMode === core.ScrollMode.Horizontal || scrollMode === core.ScrollMode.Wrapped) && currentViewMode !== core.ViewMode.SinglePage) store.get("switchViewMode")(core.ViewMode.SinglePage);
	};
	var VerticalScrollingIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M23.5,5.5c0,0.552-0.448,1-1,1h-21c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h21c0.552,0,1,0.448,1,1V5.5z\n            M23.5,13.5c0,0.552-0.448,1-1,1h-21c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h21c0.552,0,1,0.448,1,1V13.5z\n            M23.5,21.5 c0,0.552-0.448,1-1,1h-21c-0.552,0-1-0.448-1-1v-3c0-0.552,0.448-1,1-1h21c0.552,0,1,0.448,1,1V21.5z" }));
	};
	var WrappedScrollingIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M10.5,9.5c0,0.552-0.448,1-1,1h-8c-0.552,0-1-0.448-1-1v-8c0-0.552,0.448-1,1-1h8c0.552,0,1,0.448,1,1V9.5z\n            M23.5,9.5c0,0.552-0.448,1-1,1h-8c-0.552,0-1-0.448-1-1v-8c0-0.552,0.448-1,1-1h8c0.552,0,1,0.448,1,1V9.5z\n            M10.5,22.5 c0,0.552-0.448,1-1,1h-8c-0.552,0-1-0.448-1-1v-8c0-0.552,0.448-1,1-1h8c0.552,0,1,0.448,1,1V22.5z\n            M23.5,22.5c0,0.552-0.448,1-1,1 h-8c-0.552,0-1-0.448-1-1v-8c0-0.552,0.448-1,1-1h8c0.552,0,1,0.448,1,1V22.5z" }));
	};
	...
	var switchViewMode = function(store, viewMode) {
		...
		if ((currentScrollMode === core.ScrollMode.Horizontal || currentScrollMode === core.ScrollMode.Wrapped) && viewMode !== core.ViewMode.SinglePage) store.get("switchScrollMode")(core.ScrollMode.Vertical);
	};
	...
	var scrollModePlugin = function() {
		...
		var SwitchScrollModeButtonDecorator = function(props) {
			return React__namespace.createElement(SwitchScrollModeDecorator, { mode: props.mode }, function(p) {
				return React__namespace.createElement(SwitchScrollModeButton, {
					isDisabled: p.isDisabled,
					isSelected: p.isSelected,
					mode: p.mode,
		...
		var SwitchViewModeButtonDecorator = function(props) {
			return React__namespace.createElement(SwitchViewModeDecorator, { mode: props.mode }, function(p) {
				return React__namespace.createElement(SwitchViewModeButton, {
					isDisabled: p.isDisabled,
					isSelected: p.isSelected,
					mode: p.mode,
...
//#endregion
//#region node_modules/@react-pdf-viewer/scroll-mode/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/search/lib/cjs/search.js
	...
	***************************************************************************** */
	...
	var HightlightItem = function(_a) {
		...
		core.useIsomorphicLayoutEffect(function() {
			...
			if (onHighlightKeyword && highlightEle) onHighlightKeyword({
				highlightEle,
	...
	var replaceNode = function(replacementNode, node) {
		...
		if (parent) parent.insertBefore(replacementNode, node);
		removeNode(node);
	};
	...
	var Highlights = function(_a) {
		...
		var highlightAll = function(textLayerEle) {
			...
			if (charIndexes.length === 0) return [];
			var highlightPos = [];
			...
			keywordRegexp.forEach(function(keyword) {
				...
				var match;
				var matches = [];
				while ((match = cloneKeyword.exec(fullText)) !== null) matches.push({
				...
				matches.map(function(item) {
					...
					Object.values(spanIndexes).forEach(function(charIndexSpan) {
						if (charIndexSpan.length !== 1 || charIndexSpan[0].char.trim() !== "") {
							...
							if (hightlighPosition) highlightPos.push(hightlighPosition);
						}
					});
				});
			});
		...
		var handleKeywordChanged = function(keyword) {
			if (keyword && keyword.length > 0) setKeywordRegexp(keyword);
		};
		...
		var handleRenderStatusChanged = function(status) {
			if (!status.has(pageIndex)) return;
			var currentStatus = status.get(pageIndex);
			if (currentStatus) setRenderStatus({
		...
		React__namespace.useEffect(function() {
			if (isEmptyKeyword() || renderStatus.status !== core.LayerRenderStatus.DidRender || characterIndexesRef.current.length) return;
			var textLayerEle = renderStatus.ele;
			characterIndexesRef.current = [].slice.call(textLayerEle.querySelectorAll(".rpv-core__text-layer-text")).map(function(span) {
		...
		React__namespace.useEffect(function() {
			...
			var textLayerEle = renderStatus.ele;
			setHighlightAreas(highlightAll(textLayerEle));
		}, [
			keywordRegexp,
			matchPosition,
			renderStatus.status,
		...
		React__namespace.useEffect(function() {
			if (isEmptyKeyword() && renderStatus.ele && renderStatus.status === core.LayerRenderStatus.DidRender) setHighlightAreas([]);
		}, [keywordRegexp, renderStatus.status]);
		React__namespace.useEffect(function() {
			if (highlightAreas.length === 0) return;
			var container = containerRef.current;
			if (matchPosition.pageIndex !== pageIndex || !container || renderStatus.status !== core.LayerRenderStatus.DidRender) return;
			var highlightEle = container.querySelector(".rpv-search__highlight[data-index=\"".concat(matchPosition.matchIndex, "\"]"));
			if (!highlightEle) return;
			...
			if (jump) {
				...
				if (currentMatchRef.current) currentMatchRef.current.classList.remove("rpv-search__highlight--current");
	...
	var normalizeSingleKeyword = function(keyword, matchCase, wholeWords) {
		if (keyword instanceof RegExp) return {
			keyword: keyword.source,
			regExp: keyword,
			wholeWords: wholeWords || false
		};
		if (typeof keyword === "string") return keyword === "" ? EMPTY_KEYWORD_REGEXP : normalizeFlagKeyword({
			keyword,
			matchCase: matchCase || false,
			wholeWords: wholeWords || false
		});
		if (typeof matchCase !== "undefined") keyword.matchCase = matchCase;
		if (typeof wholeWords !== "undefined") keyword.wholeWords = wholeWords;
	...
	var useSearch = function(store) {
		...
		var changeMatchCase = function(isChecked) {
			...
			if (keywords.length > 0) searchFor(keywords, isChecked, wholeWords);
		};
		var changeWholeWords = function(isChecked) {
			setWholeWords(isChecked);
			if (keywords.length > 0) searchFor(keywords, matchCase, isChecked);
		};
		var jumpToMatch = function(index) {
			var numMatches = found.length;
			if (keywords.length === 0 || numMatches === 0) return null;
		...
		var jumpToGivenMatch = function(match) {
			var jumpToPage = store.get("jumpToPage");
			if (jumpToPage) jumpToPage(match.pageIndex);
		...
		var searchFor = function(keywordParam, matchCaseParam, wholeWordsParam) {
			...
			return new Promise(function(resolve, _) {
				(textContents.current.length === 0 ? getTextContents().then(function(response) {
					textContents.current = response;
					return Promise.resolve(response);
				}) : Promise.resolve(textContents.current)).then(function(response) {
					var arr = [];
	...
	var ShortcutHandler = function(_a) {
		...
		var handleKeydown = function(e) {
			...
			if (!(core.isMac() ? e.metaKey && !e.ctrlKey : e.ctrlKey)) return;
	...
	var SearchPopover = function(_a) {
		...
		var onKeydownSearch = function(e) {
			if (e.key === "Enter" && keyword) searchDone ? jumpToNextMatch() : performSearch();
		};
		...
		React__namespace.useEffect(function() {
			var initialKeyword = store.get("initialKeyword");
			if (initialKeyword && initialKeyword.length === 1 && keyword) performSearch(function() {
		...
		return React__namespace.createElement("div", { className: "rpv-search__popover" }, React__namespace.createElement("div", { className: "rpv-search__popover-input-counter" }, React__namespace.createElement(core.TextBox, {
			...
			size: "1rem"
		}), !isQuerying && React__namespace.createElement("span", { "data-testid": "search__popover-num-matches" }, currentMatch, "/", numberOfMatches))), React__namespace.createElement("label", { className: "rpv-search__popover-label" }, React__namespace.createElement("input", {
			className: "rpv-search__popover-label-checkbox",
			"data-testid": "search__popover-match-case",
			checked: matchCase,
			type: "checkbox",
			onChange: onChangeMatchCase
		}), " ", l10n && l10n.search ? l10n.search.matchCase : "Match case"), React__namespace.createElement("label", { className: "rpv-search__popover-label" }, React__namespace.createElement("input", {
			className: "rpv-search__popover-label-checkbox",
			checked: wholeWords,
			"data-testid": "search__popover-whole-words",
			type: "checkbox",
			onChange: onChangeWholeWords
		}), " ", l10n && l10n.search ? l10n.search.wholeWords : "Whole words"), React__namespace.createElement("div", { className: "rpv-search__popover-footer" }, React__namespace.createElement("div", { className: "rpv-search__popover-footer-item" }, React__namespace.createElement(core.Tooltip, {
		...
		})), React__namespace.createElement("div", { className: "rpv-search__popover-footer-item" }, React__namespace.createElement(core.Tooltip, {
	...
	var ShowSearchPopoverDecorator = function(_a) {
		...
		return children({
			icon: React__namespace.createElement(SearchIcon, null),
			label,
			onClick
		});
	};
	...
	var ShowSearchPopoverButton = function(_a) {
		...
		var handleShortcutsPressed = function(areShortcutsPressed) {
			if (areShortcutsPressed) onClick();
		};
		React__namespace.useEffect(function() {
	...
	var ShowSearchPopover = function(_a) {
		var children = _a.children, enableShortcuts = _a.enableShortcuts, store = _a.store;
		var portalPosition = React__namespace.useContext(core.ThemeContext).direction === core.TextDirection.RightToLeft ? core.Position.BottomRight : core.Position.BottomLeft;
		var defaultChildren = function(props) {
	...
	var searchPlugin = function(props) {
		...
		var SearchDecorator = function(props) {
			return React__namespace.createElement(Search, __assign({}, props, { store }));
		};
		var ShowSearchPopoverDecorator = function(props) {
			return React__namespace.createElement(ShowSearchPopover, __assign({ enableShortcuts: searchPluginProps.enableShortcuts }, props, { store }));
		};
		...
		var renderViewer = function(renderViewerProps) {
			...
			if (currentSlot.subSlot) currentSlot.subSlot.children = React__namespace.createElement(React__namespace.Fragment, null, searchPluginProps.enableShortcuts && React__namespace.createElement(ShortcutHandler, {
				containerRef: renderViewerProps.containerRef,
				store
		...
		return {
			...
			uninstall: function(props) {
				...
				if (renderStatus) renderStatus.clear();
			},
			onDocumentLoad: function(props) {
				store.update("doc", props.doc);
			},
...
//#endregion
//#region node_modules/@react-pdf-viewer/search/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/theme/lib/cjs/theme.js
var require_theme = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var DarkIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M19.5,15.106l2.4-2.4a1,1,0,0,0,0-1.414l-2.4-2.4V5.5a1,1,0,0,0-1-1H15.106l-2.4-2.4a1,1,0,0,0-1.414,0l-2.4,2.4H5.5a1,1,0,0,0-1,1V8.894l-2.4,2.4a1,1,0,0,0,0,1.414l2.4,2.4V18.5a1,1,0,0,0,1,1H8.894l2.4,2.4a1,1,0,0,0,1.414,0l2.4-2.4H18.5a1,1,0,0,0,1-1Z" }), React__namespace.createElement("path", { d: "M10,6.349a6,6,0,0,1,0,11.3,6,6,0,1,0,0-11.3Z" }));
	};
	var LightIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M19.491,15.106l2.4-2.4a1,1,0,0,0,0-1.414l-2.4-2.4V5.5a1,1,0,0,0-1-1H15.1L12.7,2.1a1,1,0,0,0-1.414,0l-2.4,2.4H5.491a1,1,0,0,0-1,1V8.894l-2.4,2.4a1,1,0,0,0,0,1.414l2.4,2.4V18.5a1,1,0,0,0,1,1H8.885l2.4,2.4a1,1,0,0,0,1.414,0l2.4-2.4h3.394a1,1,0,0,0,1-1Z" }), React__namespace.createElement("path", { d: "M11.491,6c4,0,6,2.686,6,6s-2,6-6,6Z" }));
	};
	/******************************************************************************
	Copyright (c) Microsoft Corporation.
	...
	***************************************************************************** */
	...
	var SwitchTheme = function(_a) {
		...
		return (children || defaultChildern)({ onClick: function() {
...
//#endregion
//#region node_modules/@react-pdf-viewer/theme/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/zoom/lib/cjs/zoom.js
var require_zoom = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
	...
	***************************************************************************** */
	...
	var CurrentScale = function(_a) {
		...
		return (children || defaultChildren)({ scale });
	};
	...
	var PinchZoom = function(_a) {
		...
		var handleWheelEvent = function(e) {
			...
			zoomTo(createSvgElement().createSVGMatrix().translate(originX, originY).scale(scaleDiff).translate(-originX, -originY).scale(currentScale).a);
		};
		core.useIsomorphicLayoutEffect(function() {
	...
	var increase = function(currentLevel) {
		return LEVELS.find(function(item) {
	...
	var ZoomPopover = function(_a) {
		...
		var getSpcialLevelLabel = function(level) {
			switch (level) {
				case core.SpecialZoomLevel.ActualSize: return l10n && l10n.zoom ? l10n.zoom.actualSize : "Actual size";
				case core.SpecialZoomLevel.PageFit: return l10n && l10n.zoom ? l10n.zoom.pageFit : "Page fit";
				case core.SpecialZoomLevel.PageWidth: return l10n && l10n.zoom ? l10n.zoom.pageWidth : "Page width";
			}
		};
		...
		var renderTarget = function(toggle) {
			...
			return React__namespace.createElement(core.MinimalButton, {
				...
				onClick: click
			}, React__namespace.createElement("span", { className: "rpv-zoom__popover-target" }, React__namespace.createElement("span", {
			...
			}, Math.round(scale * 100), "%"), React__namespace.createElement("span", { className: "rpv-zoom__popover-target-arrow" })));
		};
	...
	var ZoomIn = function(_a) {
		...
		var zoomIn = function() {
			var zoom = store.get("zoom");
			if (zoom) zoom(increase(scale));
		};
		return (children || ZoomInButton)({
			enableShortcuts,
			onClick: zoomIn
		});
	};
	...
	var ZoomOut = function(_a) {
		...
		var zoomIn = function() {
			var zoom = store.get("zoom");
			if (zoom) zoom(decrease(scale));
		};
		return (children || ZoomOutButton)({
			enableShortcuts,
			onClick: zoomIn
		});
	};
	...
	var zoomPlugin = function(props) {
		...
		var CurrentScaleDecorator = function(props) {
			return React__namespace.createElement(CurrentScale, __assign({}, props, { store }));
		};
		var ZoomInDecorator = function(props) {
			return React__namespace.createElement(ZoomIn, __assign({ enableShortcuts: zoomPluginProps.enableShortcuts }, props, { store }));
		};
		...
		var ZoomOutDecorator = function(props) {
			return React__namespace.createElement(ZoomOut, __assign({ enableShortcuts: zoomPluginProps.enableShortcuts }, props, { store }));
		};
		...
		var ZoomDecorator = function(props) {
			return React__namespace.createElement(Zoom, __assign({}, props, { store }));
		};
		var ZoomPopoverDecorator = function(zoomPopverProps) {
			return React__namespace.createElement(ZoomDecorator, null, function(props) {
				return React__namespace.createElement(ZoomPopover, __assign({ levels: zoomPopverProps === null || zoomPopverProps === void 0 ? void 0 : zoomPopverProps.levels }, props));
			});
		};
		var renderViewer = function(props) {
			var slot = props.slot;
			if (!zoomPluginProps.enableShortcuts) return slot;
			var updateSlot = { children: React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement(ShortcutHandler, {
				containerRef: props.containerRef,
				store
...
//#endregion
//#region node_modules/@react-pdf-viewer/zoom/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/toolbar/lib/cjs/toolbar.js
var require_toolbar = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var selectionMode = require_lib$13();
	var React = require_react();
	var fullScreen = require_lib$12();
	var getFile = require_lib$11();
	var open = require_lib$10();
	var pageNavigation = require_lib$9();
	var print = require_lib$8();
	var properties = require_lib$7();
	var rotate = require_lib$6();
	var scrollMode = require_lib$5();
	var search = require_lib$4();
	var theme = require_lib$3();
	var zoom = require_lib$2();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
		if (e) Object.keys(e).forEach(function(k) {
			if (k !== "default") {
	...
	var MoreIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M12,0.5c1.381,0,2.5,1.119,2.5,2.5S13.381,5.5,12,5.5S9.5,4.381,9.5,3S10.619,0.5,12,0.5z\n            M12,9.5\n            c1.381,0,2.5,1.119,2.5,2.5s-1.119,2.5-2.5,2.5S9.5,13.381,9.5,12S10.619,9.5,12,9.5z\n            M12,18.5c1.381,0,2.5,1.119,2.5,2.5\n            s-1.119,2.5-2.5,2.5S9.5,22.381,9.5,21S10.619,18.5,12,18.5z" }));
	};
	var PORTAL_OFFSET = {
		left: 0,
		top: 8
	...
	var MoreActionsPopover = function(_a) {
		...
		var l10n = React__namespace.useContext(core.LocalizationContext).l10n;
		var portalPosition = React__namespace.useContext(core.ThemeContext).direction === core.TextDirection.RightToLeft ? core.Position.BottomLeft : core.Position.BottomRight;
		...
		var renderContent = function(toggle) {
			return React__namespace.createElement(core.Menu, null, React__namespace.createElement("div", { className: "rpv-core__display--block rpv-core__display--hidden-medium" }, React__namespace.createElement(SwitchThemeMenuItem, { onClick: toggle })), React__namespace.createElement("div", { className: "rpv-core__display--block rpv-core__display--hidden-medium" }, React__namespace.createElement(EnterFullScreenMenuItem, { onClick: toggle })), React__namespace.createElement("div", { className: "rpv-core__display--block rpv-core__display--hidden-medium" }, React__namespace.createElement(OpenMenuItem, null)), React__namespace.createElement("div", { className: "rpv-core__display--block rpv-core__display--hidden-medium" }, React__namespace.createElement(PrintMenuItem, { onClick: toggle })), React__namespace.createElement("div", { className: "rpv-core__display--block rpv-core__display--hidden-medium" }, React__namespace.createElement(DownloadMenuItem, { onClick: toggle })), React__namespace.createElement("div", { className: "rpv-core__display--block rpv-core__display--hidden-medium" }, React__namespace.createElement(core.MenuDivider, null)), React__namespace.createElement(GoToFirstPageMenuItem, { onClick: toggle }), React__namespace.createElement("div", { className: "rpv-core__display--block rpv-core__display--hidden-medium" }, React__namespace.createElement(GoToPreviousPageMenuItem, { onClick: toggle })), React__namespace.createElement("div", { className: "rpv-core__display--block rpv-core__display--hidden-medium" }, React__namespace.createElement(GoToNextPageMenuItem, { onClick: toggle })), React__namespace.createElement(GoToLastPageMenuItem, { onClick: toggle }), React__namespace.createElement(core.MenuDivider, null), React__namespace.createElement(RotateForwardMenuItem, { onClick: toggle }), React__namespace.createElement(RotateBackwardMenuItem, { onClick: toggle }), React__namespace.createElement(core.MenuDivider, null), React__namespace.createElement(SwitchSelectionModeMenuItem, {
				...
				onClick: toggle
			}), React__namespace.createElement(core.MenuDivider, null), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-small" }, React__namespace.createElement(SwitchViewModeMenuItem, {
				mode: core.ViewMode.SinglePage,
				onClick: toggle
			})), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-small" }, React__namespace.createElement(SwitchViewModeMenuItem, {
				mode: core.ViewMode.DualPage,
				onClick: toggle
			})), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-small" }, React__namespace.createElement(SwitchViewModeMenuItem, {
				mode: core.ViewMode.DualPageWithCover,
				onClick: toggle
			})), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-small" }, React__namespace.createElement(core.MenuDivider, null)), React__namespace.createElement(ShowPropertiesMenuItem, { onClick: toggle }));
		};
		return React__namespace.createElement(core.Popover, {
			ariaControlsSuffix: "toolbar-more-actions",
			ariaHasPopup: "menu",
	...
	***************************************************************************** */
	...
	var renderDefaultToolbar = function(transformToolbarSlot) {
		return function(defaultToolbarSlot) {
			...
			}, React__namespace.createElement("div", { className: "rpv-toolbar__left" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(ShowSearchPopover, null)), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-small" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(GoToPreviousPage, null))), React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(CurrentPageInput, null), React__namespace.createElement("span", { className: "rpv-toolbar__label" }, React__namespace.createElement(NumberOfPages, null))), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-small" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(GoToNextPage, null)))), React__namespace.createElement("div", { className: "rpv-toolbar__center" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(ZoomOut, null)), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-small" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(Zoom, null))), React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(ZoomIn, null))), React__namespace.createElement("div", { className: "rpv-toolbar__right" }, React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-medium" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(SwitchTheme, null))), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-medium" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(EnterFullScreen, null))), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-medium" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(Open, null))), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-medium" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(Download, null))), React__namespace.createElement("div", { className: "rpv-core__display--hidden rpv-core__display--block-medium" }, React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(Print, null))), React__namespace.createElement("div", { className: "rpv-toolbar__item" }, React__namespace.createElement(MoreActionsPopover, { toolbarSlot }))));
		};
	};
	var defaultTransform = function(slot) {
		var NumberOfPages = slot.NumberOfPages;
		return Object.assign({}, slot, { NumberOfPages: function() {
	...
	var Toolbar = function(_a) {
		...
		return (children || DefaultToobar)(slot);
	};
		...
		return {
			...
			install: function(pluginFunctions) {
				plugins.forEach(function(plugin) {
					if (plugin.install) plugin.install(pluginFunctions);
				});
			},
			...
			renderViewer: function(props) {
				var slot = props.slot;
				plugins.forEach(function(plugin) {
					if (plugin.renderViewer) slot = plugin.renderViewer(__assign(__assign({}, props), { slot }));
				});
				return slot;
			},
			uninstall: function(pluginFunctions) {
				plugins.forEach(function(plugin) {
					if (plugin.uninstall) plugin.uninstall(pluginFunctions);
				});
			},
			onDocumentLoad: function(props) {
				plugins.forEach(function(plugin) {
					if (plugin.onDocumentLoad) plugin.onDocumentLoad(props);
				});
			},
			onAnnotationLayerRender: function(props) {
				plugins.forEach(function(plugin) {
					if (plugin.onAnnotationLayerRender) plugin.onAnnotationLayerRender(props);
				});
			},
			onTextLayerRender: function(props) {
				plugins.forEach(function(plugin) {
					if (plugin.onTextLayerRender) plugin.onTextLayerRender(props);
				});
			},
			onViewerStateChange: function(viewerState) {
				var newState = viewerState;
				plugins.forEach(function(plugin) {
					if (plugin.onViewerStateChange) newState = plugin.onViewerStateChange(newState);
				});
				return newState;
			},
			renderDefaultToolbar,
			Toolbar: React__namespace.useCallback(function(props) {
...
//#endregion
//#region node_modules/@react-pdf-viewer/toolbar/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
...
//#endregion
//#region node_modules/@react-pdf-viewer/default-layout/lib/cjs/default-layout.js
var require_default_layout = /* @__PURE__ */ __commonJSMin(((exports) => {
	var core = require_lib$17();
	var React = require_react();
	var attachment = require_lib$16();
	var bookmark = require_lib$15();
	var thumbnail = require_lib$14();
	var toolbar = require_lib$1();
	function _interopNamespaceDefault(e) {
		var n = Object.create(null);
		if (e) Object.keys(e).forEach(function(k) {
			if (k !== "default") {
	...
	var BookmarkIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M11.5,1.5h11c0.552,0,1,0.448,1,1v20c0,0.552-0.448,1-1,1h-21c-0.552,0-1-0.448-1-1v-20c0-0.552,0.448-1,1-1h3\n            M11.5,10.5c0,0.55-0.3,0.661-0.659,0.248L8,7.5l-2.844,3.246c-0.363,0.414-0.659,0.3-0.659-0.247v-9c0-0.552,0.448-1,1-1h5\n            c0.552,0,1,0.448,1,1L11.5,10.5z\n            M14.5,6.499h6\n            M14.5,10.499h6\n            M3.5,14.499h17\n            M3.5,18.499h16.497" }));
	};
	/******************************************************************************
	Copyright (c) Microsoft Corporation.
	...
	***************************************************************************** */
	...
	var FileIcon = function() {
		return React__namespace.createElement(core.Icon, { size: 16 }, React__namespace.createElement("path", { d: "M7.618,15.345l8.666-8.666c0.78-0.812,2.071-0.838,2.883-0.058s0.838,2.071,0.058,2.883\n            c-0.019,0.02-0.038,0.039-0.058,0.058L7.461,21.305c-1.593,1.593-4.175,1.592-5.767,0s-1.592-4.175,0-5.767c0,0,0,0,0,0\n            L13.928,3.305c2.189-2.19,5.739-2.19,7.929-0.001s2.19,5.739,0,7.929l0,0L13.192,19.9" }));
	};
	...
	var Sidebar = function(_a) {
		...
		var toggleTab = function(index) {
			if (currentTab === index) {
				...
				var container = containerRef.current;
				if (container) {
					if (container.style.width) container.style.removeProperty("width");
				}
			} else store.update("currentTab", index);
		};
		...
		if (listTabs.length === 0) return React__namespace.createElement(React__namespace.Fragment, null);
		return React__namespace.createElement(React__namespace.Fragment, null, React__namespace.createElement("div", {
			...
			ref: containerRef
		}, React__namespace.createElement("div", { className: "rpv-default-layout__sidebar-tabs" }, React__namespace.createElement("div", {
			...
			role: "tabpanel",
			tabIndex: -1
		}, listTabs[currentTab].content))), opened && React__namespace.createElement(core.Splitter, { constrain: resizeConstrain }));
	};
	var defaultLayoutPlugin = function(props) {
		...
		return {
			...
			toggleTab: function(index) {
				...
				store.update("isCurrentTabOpened", !store.get("isCurrentTabOpened"));
				if (currentTab !== index) store.update("currentTab", index);
			},
			install: function(pluginFunctions) {
				plugins.forEach(function(plugin) {
					if (plugin.install) plugin.install(pluginFunctions);
			...
			renderPageLayer: function(renderProps) {
				return React__namespace.createElement(React__namespace.Fragment, null, plugins.map(function(plugin, idx) {
					return plugin.renderPageLayer ? React__namespace.createElement(React__namespace.Fragment, { key: idx }, plugin.renderPageLayer(renderProps)) : React__namespace.createElement(React__namespace.Fragment, { key: idx }, React__namespace.createElement(React__namespace.Fragment, null));
				}));
			},
			renderViewer: function(renderProps) {
				var slot = renderProps.slot;
				plugins.forEach(function(plugin) {
					if (plugin.renderViewer) slot = plugin.renderViewer(__assign(__assign({}, renderProps), { slot }));
				});
				...
				slot.children = React__namespace.createElement("div", { className: "rpv-default-layout__container" }, React__namespace.createElement("div", {
				...
				}, React__namespace.createElement("div", { className: "rpv-default-layout__toolbar" }, props && props.renderToolbar ? props.renderToolbar(Toolbar) : React__namespace.createElement(Toolbar, null)), React__namespace.createElement("div", __assign({}, mergeSubSlot), slot.subSlot.children))), slot.children);
				slot.subSlot.attrs = {};
			...
			onDocumentLoad: function(documentLoadProps) {
				plugins.forEach(function(plugin) {
					if (plugin.onDocumentLoad) plugin.onDocumentLoad(documentLoadProps);
				});
				if (props && props.setInitialTab) props.setInitialTab(documentLoadProps.doc).then(function(initialTab) {
...
//#endregion
//#region node_modules/@react-pdf-viewer/default-layout/lib/index.js
/**
* A React component to view a PDF document
*
* @see https://react-pdf-viewer.dev
