...
var HeaderCellComp = ({ ctrl }) => {
  ...
  const cssManager = (0, import_react7.useRef)();
  if (isAlive && !cssManager.current) {
    cssManager.current = new import_ag_grid_community8.CssClassManager(() => eGui.current);
  }
  const setRef2 = (0, import_react7.useCallback)((eRef) => {
    ...
    const compProxy = {
      ...
      setAriaSort: (sort) => {
        if (eGui.current) {
          sort ? (0, import_ag_grid_community8._setAriaSort)(eGui.current, sort) : (0, import_ag_grid_community8._removeAriaSort)(eGui.current);
        }
      },
...
var HeaderFilterCellComp = ({ ctrl }) => {
  ...
  const setRef2 = (0, import_react8.useCallback)((eRef) => {
    ...
    userCompPromise.current = new import_ag_grid_community9.AgPromise((resolve) => {
  ...
  const enableFilterHandlers = (0, import_react8.useMemo)(() => gos.get("enableFilterHandlers"), []);
  const floatingFilterCompProxy = (0, import_react8.useRef)();
  ...
  const reactUserComp = userCompDetails?.componentFromFramework;
  const UserCompClass = userCompDetails?.componentClass;
  return /* @__PURE__ */ import_react8.default.createElement("div", { ref: setRef2, style: userStyles, className, role: "gridcell" }, /* @__PURE__ */ import_react8.default.createElement("div", { ref: eFloatingFilterBody, className: bodyClassName, role: "presentation" }, reactUserComp ? reactiveCustomComponents ? floatingFilterProps && /* @__PURE__ */ import_react8.default.createElement(
  ...
  ) : /* @__PURE__ */ import_react8.default.createElement(UserCompClass, { ...userCompDetails.params, ref: userCompStateless ? () => {
  } : userCompRef }) : null), /* @__PURE__ */ import_react8.default.createElement(
    "div",
    {
      ref: eButtonWrapper,
...
var HeaderGroupCellComp = ({ ctrl }) => {
  ...
  const colId = (0, import_react10.useMemo)(() => ctrl.column.getUniqueId(), []);
  ...
  return /* @__PURE__ */ import_react10.default.createElement(
    ...
    /* @__PURE__ */ import_react10.default.createElement("div", { ref: eHeaderCompWrapper, className: "ag-header-cell-comp-wrapper", role: "presentation" }, reactUserComp ? userCompStateless ? /* @__PURE__ */ import_react10.default.createElement(UserCompClass, { ...userCompDetails.params }) : /* @__PURE__ */ import_react10.default.createElement(UserCompClass, { ...userCompDetails.params, ref: userCompRef }) : null),
    /* @__PURE__ */ import_react10.default.createElement("div", { ref: eResize, "aria-hidden": resizableAriaHidden, className: resizableClassName })
  );
};
...
var HeaderRowComp = ({ ctrl }) => {
  ...
  const setRef2 = (0, import_react11.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_ag_grid_community11._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef) {
      return;
    }
    const compProxy = {
  ...
  return /* @__PURE__ */ import_react11.default.createElement("div", { ref: setRef2, className, role: "row", style, "aria-rowindex": ariaRowIndex }, cellCtrls.map(createCellJsx));
};
...
var HeaderRowContainerComp = ({ pinned }) => {
  ...
  const setRef2 = (0, import_react12.useCallback)((eRef) => {
    eGui.current = eRef;
    headerRowCtrlRef.current = eRef ? context.createBean(new import_ag_grid_community12.HeaderRowContainerCtrl(pinned)) : context.destroyBean(headerRowCtrlRef.current);
    if (!eRef) {
      return;
    }
    const compProxy = {
  ...
  return pinnedLeft ? /* @__PURE__ */ import_react12.default.createElement("div", { ref: setRef2, className: "ag-pinned-left-header " + className, "aria-hidden": !displayed, role: "rowgroup" }, insertRowsJsx()) : pinnedRight ? /* @__PURE__ */ import_react12.default.createElement("div", { ref: setRef2, className: "ag-pinned-right-header " + className, "aria-hidden": !displayed, role: "rowgroup" }, insertRowsJsx()) : centre ? /* @__PURE__ */ import_react12.default.createElement("div", { ref: setRef2, className: "ag-header-viewport " + className, role: "presentation", tabIndex: -1 }, /* @__PURE__ */ import_react12.default.createElement("div", { ref: eCenterContainer, className: "ag-header-container", role: "rowgroup" }, insertRowsJsx())) : null;
};
...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react13.useCallback)((eRef) => {
    eGui.current = eRef;
    gridCtrlRef.current = eRef ? context.createBean(new import_ag_grid_community13.GridHeaderCtrl()) : context.destroyBean(gridCtrlRef.current);
    if (!eRef)
      return;
    const compProxy = {
      toggleCss: (name, on) => setCssClasses((prev) => prev.setClass(name, on)),
...
var CellEditorComponentProxy = class {
  constructor(cellEditorParams, refreshProps) {
    ...
    this.refreshProps = refreshProps;
    this.instanceCreated = new import_ag_grid_community14.AgPromise((resolve) => {
      this.resolveInstanceCreated = resolve;
    });
...
var PopupEditorComp = (props) => {
  ...
  useEffectOnce(() => {
    ...
    const translate = (0, import_ag_grid_community15._getLocaleTextFunc)(localeSvc);
  ...
  (0, import_react16.useLayoutEffect)(() => {
    return () => {
      if (cellCtrl.isCellFocused() && popupEditorWrapper?.getGui().contains((0, import_ag_grid_community15._getActiveDomElement)(beans))) {
...
var CellComp = ({
  ...
  if (!cssManager.current) {
    cssManager.current = new import_ag_grid_community16.CssClassManager(() => eGui.current);
  }
  ...
  const init = (0, import_react20.useCallback)(() => {
    ...
    compBean.current = eRef ? context.createBean(new import_ag_grid_community16._EmptyBean()) : context.destroyBean(compBean.current);
  ...
  const showCellOrEditor = () => {
    const showCellValue = () => {
      ...
      return showCellWrapper ? /* @__PURE__ */ import_react20.default.createElement("span", { role: "presentation", id: `cell-${instanceId}`, className: "ag-cell-value", ref: setCellValueRef }, valueOrCellComp()) : valueOrCellComp();
    };
...
var RowComp = ({ rowCtrl, containerType }) => {
  ...
  const setRef2 = (0, import_react21.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_ag_grid_community17._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef) {
...
var RowContainerComp = ({ name }) => {
  ...
  const containerOptions = (0, import_react22.useMemo)(() => (0, import_ag_grid_community18._getRowContainerOptions)(name), [name]);
  ...
  const viewportClasses = (0, import_react22.useMemo)(() => classesList("ag-viewport", (0, import_ag_grid_community18._getRowViewportClass)(name)), [name]);
  const containerClasses = (0, import_react22.useMemo)(() => classesList((0, import_ag_grid_community18._getRowContainerClass)(name)), [name]);
  const spanClasses = (0, import_react22.useMemo)(() => classesList("ag-spanning-container", (0, import_ag_grid_community18._getRowSpanContainerClass)(name)), [name]);
  ...
  const setRef2 = (0, import_react22.useCallback)(() => {
    ...
    if (areElementsReady()) {
      ...
      rowContainerCtrlRef.current = context.createBean(new import_ag_grid_community18.RowContainerCtrl(name));
  ...
  const buildContainer = () => /* @__PURE__ */ import_react22.default.createElement("div", { className: containerClasses, ref: setContainerRef, role: "rowgroup" }, rowCtrlsOrdered.map((rowCtrl) => /* @__PURE__ */ import_react22.default.createElement(rowComp_default, { rowCtrl, containerType: containerOptions.type, key: rowCtrl.instanceId })));
  if (!shouldRenderViewport) {
    return buildContainer();
  }
  const buildSpanContainer = () => /* @__PURE__ */ import_react22.default.createElement("div", { className: spanClasses, ref: setSpanContainerRef, role: "rowgroup" }, spannedRowCtrlsOrdered.map((rowCtrl) => /* @__PURE__ */ import_react22.default.createElement(rowComp_default, { rowCtrl, containerType: containerOptions.type, key: rowCtrl.instanceId })));
  return /* @__PURE__ */ import_react22.default.createElement("div", { className: viewportClasses, ref: setViewportRef, role: "presentation" }, buildContainer(), isSpanning ? buildSpanContainer() : null);
};
...
var GridBodyComp = () => {
  ...
  if (!cssManager.current) {
    cssManager.current = new import_ag_grid_community19.CssClassManager(() => eRoot.current);
  }
  ...
  const setRef2 = (0, import_react23.useCallback)((eRef) => {
    ...
    addComp(eRef, import_ag_grid_community19.FakeHScrollComp, " AG Fake Horizontal Scroll ");
    const overlayComp = overlays?.getOverlayWrapperCompClass();
    if (overlayComp) {
      addComp(eRef, overlayComp, " AG Overlay Wrapper ");
    }
    if (eBody.current) {
      addComp(eBody.current, import_ag_grid_community19.FakeVScrollComp, " AG Fake Vertical Scroll ");
    }
    const compProxy = {
      setRowAnimationCssOnBodyViewport: setRowAnimationClass,
      setColumnCount: (count) => {
        if (eRoot.current) {
          (0, import_ag_grid_community19._setAriaColCount)(eRoot.current, count);
        }
      },
      setRowCount: (count) => {
        if (eRoot.current) {
          (0, import_ag_grid_community19._setAriaRowCount)(eRoot.current, count);
        }
      },
      setTopHeight,
      setBottomHeight,
      ...
      registerBodyViewportResizeListener: (listener) => {
        if (eBodyViewport.current) {
          const unsubscribeFromResize = (0, import_ag_grid_community19._observeResize)(beans, eBodyViewport.current, listener);
    ...
    const ctrl = context.createBean(new import_ag_grid_community19.GridBodyCtrl());
...
var TabGuardCompRef = (props, forwardRef4) => {
  ...
  const setupCtrl = (0, import_react24.useCallback)(() => {
    ...
    if (topTabGuard && bottomTabGuard) {
      ...
      tabGuardCtrlRef.current = context.createBean(
        new import_ag_grid_community20.TabGuardCtrl({
          comp: compProxy,
  ...
  const createTabGuard = (side) => {
    const className = side === "top" ? import_ag_grid_community20.TabGuardClassNames.TAB_GUARD_TOP : import_ag_grid_community20.TabGuardClassNames.TAB_GUARD_BOTTOM;
    return /* @__PURE__ */ import_react24.default.createElement(
      "div",
      {
        className: `${import_ag_grid_community20.TabGuardClassNames.TAB_GUARD} ${className}`,
        role: "presentation",
...
var GridComp = ({ context }) => {
  ...
  const beans = (0, import_react25.useMemo)(() => {
  ...
  const setRef2 = (0, import_react25.useCallback)((eRef) => {
    ...
    gridCtrlRef.current = eRef ? context.createBean(new import_ag_grid_community21.GridCtrl()) : context.destroyBean(gridCtrlRef.current);
  ...
  return /* @__PURE__ */ import_react25.default.createElement("div", { ref: setRef2, className: rootWrapperClasses, style: topStyle, role: "presentation" }, /* @__PURE__ */ import_react25.default.createElement("div", { className: rootWrapperBodyClasses, ref: setGridBodyParent, role: "presentation" }, initialised && eGridBodyParent && beans && /* @__PURE__ */ import_react25.default.createElement(BeansContext.Provider, { value: beans }, /* @__PURE__ */ import_react25.default.createElement(
...
var RenderStatusService = class extends import_ag_grid_community22.BeanStub {
  wireBeans(beans) {
...
var AgGridReactUi = (props) => {
  ...
  const eGui = (0, import_react26.useRef)(null);
  ...
  const setRef2 = (0, import_react26.useCallback)((eRef) => {
    ...
    const mergedGridOps = (0, import_ag_grid_community23._combineAttributesAndGridOptions)(
      props.gridOptions,
      props,
    ...
    const gridCoreCreator = new import_ag_grid_community23.GridCoreCreator();
  ...
  (0, import_react26.useEffect)(() => {
    ...
    processWhenReady(() => {
      if (apiRef.current) {
        (0, import_ag_grid_community23._processOnChange)(changes, apiRef.current);
      }
    });
  }, [props]);
  const renderMode = !import_react26.default.useSyncExternalStore || (0, import_ag_grid_community23._getGridOption)(props, "renderingMode") === "legacy" ? "legacy" : "default";
  return /* @__PURE__ */ import_react26.default.createElement("div", { style, className: props.className, ref: setRef2 }, /* @__PURE__ */ import_react26.default.createElement(RenderModeContext.Provider, { value: renderMode }, context && !context.isDestroyed() ? /* @__PURE__ */ import_react26.default.createElement(gridComp_default, { context }) : null, portalManager.current?.getPortals() ?? null));
};
  ...
  Object.keys(nextProps).forEach((propKey) => {
    if (excludeReactCompProps.has(propKey)) {
      if (deprecatedReactCompProps.has(propKey)) {
        (0, import_ag_grid_community23._warn)(274, { prop: propKey });
      }
      return;
    }
...
var ReactFrameworkComponentWrapper = class extends import_ag_grid_community23.BaseComponentWrapper {
  ...
  createWrapper(UserReactComponent, componentType) {
    ...
    const reactiveCustomComponents = (0, import_ag_grid_community23._getGridOption)(gridOptions, "reactiveCustomComponents");
    if (reactiveCustomComponents) {
      const getComponentClass = (propertyName) => {
        switch (propertyName) {
          case "filter":
            return (0, import_ag_grid_community23._getGridOption)(gridOptions, "enableFilterHandlers") ? FilterDisplayComponentWrapper : FilterComponentWrapper;
          case "floatingFilterComponent":
            return (0, import_ag_grid_community23._getGridOption)(gridOptions, "enableFilterHandlers") ? FloatingFilterDisplayComponentWrapper : FloatingFilterComponentWrapper;
          case "dateComponent":
...
var DetailCellRenderer = (0, import_react26.forwardRef)((props, ref) => {
  ...
  const parentModules = (0, import_react26.useMemo)(
    () => (0, import_ag_grid_community23._getGridRegisteredModules)(props.api.getGridId(), detailGridOptions?.rowModelType ?? "clientSide"),
    [props]
  );
  ...
  if (props.template) {
    (0, import_ag_grid_community23._warn)(230);
  }
  const setRef2 = (0, import_react26.useCallback)((eRef) => {
    ...
    if (gos.get("detailRowAutoHeight")) {
      const checkRowSizeFunc = () => {
        ...
        if (clientHeight != null && clientHeight > 0) {
          const updateRowHeightFunc = () => {
            ...
            if ((0, import_ag_grid_community23._isClientSideRowModel)(gos, rowModel) || (0, import_ag_grid_community23._isServerSideRowModel)(gos, rowModel)) {
      ...
      resizeObserverDestroyFunc.current = (0, import_ag_grid_community23._observeResize)(beans, eRef, checkRowSizeFunc);
      checkRowSizeFunc();
    }
  }, []);
...
var ReactFrameworkOverrides = class extends import_ag_grid_community23.VanillaFrameworkOverrides {
